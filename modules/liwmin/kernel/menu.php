  ...
  return  Array(
       'users'=>Array(
            ...
            'pages'=>Array(
                ...
                'report'=>Array('Отчёт по работникам', 1),
                'mass_message_list'=>Array('Массовые сообщения', 1),
				'sendmail_list'=>Array('Рассылка сообщений', 1),
                'service_list'=>Array('Платные сервисы', 1),
                'smile_collection_list'=>Array('Список смайлов', 1),
        ...
        'weapons'=>Array(
            ...
            'icon'=>'images/cms_icons/cms_SiteStructure.gif',
            'pages'=>Array(
                'attack_list'=>Array('Список ударов', 1), 
                'weapon_list'=>Array('Список оружия', 256), 
                'weapon_category_list'=>Array('Категории оружия', 1),
                'weapon_property_list'=>Array('Параметры оружия', 1),
                'dealers_custom_item_list'=>Array('Конструктор дома дилеров', 262144),
            )
        ),
        ...
        'bots'=>Array(
            ...
            'pages'=>Array(
                ...
                'fight_statistics'=>Array('Распределение в мире', 1), 
            )
        ),
        ...
        'other'=>Array(
            ...
            'pages'=>Array(
                ...
                'payments'=>Array('Оплаты', 65536), 
                 'payments_dd_dnv'=>Array('Дом дилеров (DNV)', 65536), 
                'payments_dd_usd'=>Array('Дом дилеров (USD)', 65536), 
            )
        ),
