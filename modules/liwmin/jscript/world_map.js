    ...
    switch (dir) 
    {
        case 'down':
            ...
            for (i=-width; i<=width; i++) {
                ...
                img_src = 'http://image.neverlands.ru/map/world/small/'+(current_y+height)+'/'+(current_x+i)+'_'+(current_y+height)+'.jpg';
        ...
        case 'right':
            ...
            for (i=0; i<=(height*2); i++) {
                ...
                img_src = 'http://image.neverlands.ru/map/world/small/'+(current_y-height+i)+'/'+(current_x+width)+'_'+(current_y-height+i)+'.jpg';
                td = d.createElement('TD');
                td.style.backgroundImage = 'url('+img_src+')';
                td.style.borderRight = '1px solid black';
                td.style.borderBottom = '1px solid black';
...
function showMap(x, y)
{
    ...
    for (i=-height; i<=height; i++) {
        ...
        for (j=-width; j<=width; j++) {
            td = d.createElement('TD');
            td.style.backgroundImage = 'url(http://image.neverlands.ru/map/world/small/'+(y+i)+'/'+(x+j)+'_'+(y+i)+'.jpg)';
            td.style.borderRight = '1px solid black';
            td.style.borderBottom = '1px solid black';
