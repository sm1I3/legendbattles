...
function loadZones()
{
    ...
    x2 = current_x+width;
    y2 = current_y+height;
    ajaxGet('resource_group_map.php?action=load&x1='+x1+'&y1='+y1+'&x2='+x2+'&y2='+y2, function(data) { 
        removeAllZones();
        tarr = data.split('|');
...
function saveZones()
{
    ...
    ajaxPost('resource_group_map.php', params, function(data) { alert(data); loadZones();} );
}
