...
<head>
    ...
    <script type="text/javascript" language="javascript" src="/v2/fonts/PTSans_400-PTSans_700.font.js"
                ...
                <div class="b-main-frame b-main-frame_left-side">
                    ...
                    <div class="b-main-frame__cont">
                        <div class="b-index-decor b-index-decor_right">
                            <a href="/world.php" class="b-button-red-large b-button-red-large_enter-game"
                               onclick="return openPopup('#authPopup');">
                                <span class="b-button-red-large__inner" data-font="PTSans">Войти в игру</span>
                            </a>
                            <a href="/reg.php" class="b-button-blue-large b-button-blue-large_download"
                               onclick="return openPopup('#regPopup');">
	...
	<td colspan="2">
                                    ...
                                    <div class="b-common-block__bgl">
                                        <div class="b-common-block__bgr clearfix">
                                            <div class="b-communities text-center">
                                                ...
                                                <a href="http://vk.com/public76407285" target="_blank"
                                                   class="b-communities__link">
                ...
                <div class="b-main-frame">
                    ...
                    <div class="b-main-frame__cont">
                            ...
                            <script type="text/javascript">
                                $(function () {
                                    var data = [{
                                        "id": "1",
                                        "title": "\u0441\u0443\u0432\u0435\u043d\u0438\u0440",
                                        "url": "http:\/\/forum.legendbattles.ru",
                                        "target": "_blank",
                                        "picture": "",
                                        "flash": "\/gl.baner.swf",
                                        "block": "1",
						...
						<span class="b-submenu__button-inner">Новичкам</span>
                                ...
                                <a href="http://games.mail.ru/support/legendbattles/"
                                   class="b-submenu__item b-submenu__item_support" target="_blank">
                                    <span class="b-submenu__bg"></span>
                                    <span class="b-submenu__button">
						<span class="b-submenu__button-inner">Медиа</span>
					</span>
                                </a>
                                <a href="/info/kommercheskii-sektor/uslugi"
                                   class="b-submenu__item b-submenu__item_services">
                                    <span class="b-submenu__bg"></span>
                                    <span class="b-submenu__button">
        ...
        <div class="b-footer b-footer_main">
            ...
            <div class="b-footer__bottom">
                <a href="#" target="_blank" class="b-footer__copyright-block">
        ...
        <div class="b-common-block__cont">
            <div class="b-common-block__bgl">
                <div class="b-common-block__bgr clearfix">
                    ...
                    <p class="text-center">
                        <a href="#" onclick="changePopup('#authPopup', '#regPopup'); return false;"
                           class="b-button-green-5">
        ...
        <div class="b-common-block__cont">
            <div class="b-common-block__bgl">
                <div class="b-common-block__bgr clearfix" id="sendPasswordContainer">
                    <form action="password.php" method="post" class="b-auth-form"
