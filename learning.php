...
<head>
    ...
    <meta name="keywords"
          content="игры онлайн, игры, rpg игра, играть, рпг, онлайн, online, стратегия, мморпг, mmorpg, браузерная, игрового, игрокам"/>
    ...
    <meta name="copyright" content="http://ereality.org"/>
    <link rel="shortcut icon" href="/favicon.ico"/>
    <link rel="STYLESHEET" href="/css/d2009.css?20091109a" type="text/css"/>
    <link rel="STYLESHEET" href="/static/css/?id=5&rev=39" type="text/css"/>
...
<div class="content" style="text-align:center">
    <div>
        ...
        <p class="main_text_aboutthegame">
            <font color=#993399><b>Для начала,вам не обходимо взять квест,который вы сможете найти нажав <font
                            color=#CC0033> "Локация/квест"</b>
        </p>
        <center><a href="http://i.imgur.com/38ht98n.png" rel="lightbox" title="Информация"
        ...
        <p class="main_text_aboutthegame">
            1.Вам не обходима зайти в инвентарь использовать "Сдобную булочку <img
                    src="http://img.legendbattles.ru/image/weapon/bulki.png">
        </p>
        Потом нажимаем на кнопку Назад и видим.
        </p>
        <center><a href="http://i.imgur.com/mX8Ck9k.png" rel="lightbox" title="Информация."
                   onFocus="this.blur();"><img
                        src="http://i.imgur.com/mX8Ck9k.png" width="694" height="361"></a></center>
        <p class="main_text_aboutthegame">
            2.В квести было указано использовать булочку и потом поговорить с Вождём.<img
                    src="http://i.imgur.com/yxuiyPj.png">
        </p>
        <p class="main_text_aboutthegame">
            Вождь Торгор. Прежде чем слушать отключите обновления фрейма. Который находться в настройках
            ПЕРСОНАЖА. Послушать
        </p>
        <center><a href="http://i.imgur.com/LdM0Vjz.png" rel="lightbox" title="Информация."
                   onFocus="this.blur();"><img
                        src="http://i.imgur.com/LdM0Vjz.png" width="794" height="261"></a></center>
        <center><a href="http://i.imgur.com/tin0NRM.png" rel="lightbox" title="Информация."
                   onFocus="this.blur();"><img
        ...
        <center><a href="http://i.imgur.com/EXSYT1M.png" rel="lightbox" title="Информация."
                   onFocus="this.blur();"><img
        ...
        <center><a href="http://i.imgur.com/LSTCmYK.png" rel="lightbox" title="Информация."
                   onFocus="this.blur();"><img
        ...
        <center><a href="http://i.imgur.com/aRtiiBL.png" rel="lightbox" title="Информация."
                   onFocus="this.blur();"/><img
                    src="http://i.imgur.com/aRtiiBL.png" width="894" height="361"
            <td width="700" height="230" valign="top" class="main_text">
                <div style="padding-right:30px; width:700px;
height:130px;"></div>
            </td>
        </center>
        ...
        <center><a href="http://i.imgur.com/4oxxWEo.png" rel="lightbox" title="Информация."
                   onFocus="this.blur();"/><img
                    src="http://i.imgur.com/4oxxWEo.png" width="794" height="461"
            <td width="700" height="230" valign="top" class="main_text">
                <div style="padding-right:30px; width:700px;
height:130px;">
                    <center><a href="http://i.imgur.com/FznHvAO.png" rel="lightbox" title="Информация."
                               onFocus="this.blur();"/><img
...
height:130px;">
                    ...
                    <center><a href="http://i.imgur.com/YPUBt3p.png" rel="lightbox" title="Информация."
                               onFocus="this.blur();"/><img
...
height:130px;">
                    <p class="main_text_aboutthegame" style="margin:10px;">
                        Вот мы и пришли заключению... Теперь не забудем включить обновления фрейма И после того нажимаем
                        Локация и возвращаемся к Военной Школе.
                    </p>
                    <center><a href="http://i.imgur.com/p2Mf1Mt.png" rel="lightbox" title="Информация."
                               onFocus="this.blur();"/><img
...
height:130px;"></div>
            ...
            <center><a href="http://i.imgur.com/KW6jDy5.png" rel="lightbox" title="Информация."
                       onFocus="this.blur();"/><img
...
height:130px;"></div>
                ...
                <center><a href="http://i.imgur.com/0wmV7AN.png" rel="lightbox" title="Информация."
                           onFocus="this.blur();"/><img
...
height:130px;">
                            ...
                            <center><strong>Системная информация! Квест выполнен. Вы получили: Боевой опыт (50), 20,
                                    «Банка
                                    восстановления 50 НР», «Банка восстановления 50 НР», «Банка восстановления 50 НР»,
                                    «Банка
                                    восстановления 50 НР», «Банка восстановления 50 НР».
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <td bgcolor="#FFFFFF"><img src="http://img.legendbattles.ru/image/1x1.gif" width="1"
                                                       height="3"></td>
                            </tr>
                            <tr>
                                <div style="background-color:#cacaca; width:100%;" align="center"><a
