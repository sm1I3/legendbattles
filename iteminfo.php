...
function itemparams($inv,$ITEM,$player,$plstt,$mass){	
	...
	//if($par){	
    if ($ITEM['srok'] > 0) {
        $par_i .= "&nbsp;Время Жизни: <font color=#BB0000><b>" . $ITEM['srok'] . "</b></font> Дней<br>";
    }
		if($ITEM['type']=='w70'){
            if ($ITEM['effect'] > 0) {
		...
		foreach ($par as $value){
			...
			switch($stat[0]){
				...
				case 2:
					...
					break;
                case 3:
                    $par_i .= "&nbsp;Карманов: <b>" . $modstroke . "</b><br>";
                    break;
                case 4:
                    $par_i .= "&nbsp;Описание: <b>" . $modstroke . "</b><br>";
                    break;
                case 5:
                    $par_i .= "&nbsp;Уловка: $plus<b>" . $modstroke . "</b><br>";
                    break;
                case 6:
                    $par_i .= "&nbsp;Точность: $plus<b>" . $modstroke . "</b><br>";
                    break;
                case 7:
                    $par_i .= "&nbsp;Сокрушение: $plus<b>" . $modstroke . "</b><br>";
                    break;
                case 8:
                    $par_i .= "&nbsp;Стойкость: $plus<b>" . $modstroke . "</b><br>";
                    break;
                case 9:
                    $par_i .= "&nbsp;Класс брони: <b>" . $modstroke . "</b><br>";
                    break;
                case 10:
                    $par_i .= "&nbsp;Пробой брони: $plus<b>" . $modstroke . "</b><br>";
                    break;
                case 11:
                    $par_i .= "&nbsp;Пробой колющим ударом: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 12:
                    $par_i .= "&nbsp;Пробой режущим ударом: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 13:
                    $par_i .= "&nbsp;Пробой проникающим ударом: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 14:
                    $par_i .= "&nbsp;Пробой пробивающим ударом: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 15:
                    $par_i .= "&nbsp;Пробой рубящим ударом: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 16:
                    $par_i .= "&nbsp;Пробой карающим ударом: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 17:
                    $par_i .= "&nbsp;Пробой отсекающим ударом: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 18:
                    $par_i .= "&nbsp;Пробой дробящим ударом: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 19:
                    $par_i .= "&nbsp;Защита от колющих ударов: $plus<b>" . $modstroke . "</b><br>";
                    break;
                case 20:
                    $par_i .= "&nbsp;Защита от режущих ударов: $plus<b>" . $modstroke . "</b><br>";
                    break;
                case 21:
                    $par_i .= "&nbsp;Защита от проникающих ударов: $plus<b>" . $modstroke . "</b><br>";
                    break;
                case 22:
                    $par_i .= "&nbsp;Защита от пробивающих ударов: $plus<b>" . $modstroke . "</b><br>";
                    break;
                case 23:
                    $par_i .= "&nbsp;Защита от рубящих ударов: $plus<b>" . $modstroke . "</b><br>";
                    break;
                case 24:
                    $par_i .= "&nbsp;Защита от карающих ударов: $plus<b>" . $modstroke . "</b><br>";
                    break;
                case 25:
                    $par_i .= "&nbsp;Защита от отсекающих ударов: $plus<b>" . $modstroke . "</b><br>";
                    break;
                case 26:
                    $par_i .= "&nbsp;Защита от дробящих ударов: $plus<b>" . $modstroke . "</b><br>";
                    break;
                case 27:
                    $par_i .= "&nbsp;НР: $plus<b>" . $modstroke . "</b><br>";
                    break;
                case 28:
                    $par_i .= "&nbsp;Очки действия: $plus<b>" . $modstroke . "</b><br>";
                    break;
                case 29:
                    $par_i .= "&nbsp;Мана: $plus<b>" . $modstroke . "</b><br>";
                    break;
                case 30:
                    $par_i .= "&nbsp;Мощь: $plus<b>" . $modstroke . "</b><br>";
                    break;
                case 31:
                    $par_i .= "&nbsp;Проворность: $plus<b>" . $modstroke . "</b><br>";
                    break;
                case 32:
                    $par_i .= "&nbsp;Везение: $plus<b>" . $modstroke . "</b><br>";
                    break;
                case 33:
                    $par_i .= "&nbsp;Здоровье: $plus<b>" . $modstroke . "</b><br>";
                    break;
                case 34:
                    $par_i .= "&nbsp;Разум: $plus<b>" . $modstroke . "</b><br>";
                    break;
                case 35:
                    $par_i .= "&nbsp;Сноровка: $plus<b>" . $modstroke . "</b><br>";
                    break;
                case 36:
                    $par_i .= "&nbsp;Владение мечами: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 37:
                    $par_i .= "&nbsp;Владение топорами: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 38:
                    $par_i .= "&nbsp;Владение дробящим оружием: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 39:
                    $par_i .= "&nbsp;Владение ножами: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 40:
                    $par_i .= "&nbsp;Владение метательным оружием: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 41:
                    $par_i .= "&nbsp;Владение алебардами и копьями: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 42:
                    $par_i .= "&nbsp;Владение посохами: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 43:
                    $par_i .= "&nbsp;Владение экзотическим оружием: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 44:
                    $par_i .= "&nbsp;Владение двуручным оружием: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 53:
                    $par_i .= "&nbsp;Воровство: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 54:
                    $par_i .= "&nbsp;Осторожность: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 55:
                    $par_i .= "&nbsp;Палач: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 56:
                    $par_i .= "&nbsp;Наблюдательность: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 57:
                    $par_i .= "&nbsp;Торговля: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 58:
                    $par_i .= "&nbsp;Странник: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 59:
                    $par_i .= "&nbsp;Рыболов: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 60:
                    $par_i .= "&nbsp;Лесоруб: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 61:
                    $par_i .= "&nbsp;Ювелирное дело: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 62:
                    $par_i .= "&nbsp;Самолечение: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 63:
                    $par_i .= "&nbsp;Оружейник: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 64:
                    $par_i .= "&nbsp;Доктор: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 65:
                    $par_i .= "&nbsp;Самолечение: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 66:
                    $par_i .= "&nbsp;Быстрое восстановление маны: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 67:
                    $par_i .= "&nbsp;Лидерство: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 68:
                    $par_i .= "&nbsp;Алхимия: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 69:
                    $par_i .= "&nbsp;Развитие горного дела: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 70:
                    $par_i .= "&nbsp;Травничество: $plus<b>" . $modstroke . "%</b><br>";
                    break;
                case 71:
                    $par_i .= "&nbsp;<font color=#BB0000>Коэффициент: $plus<b>" . $modstroke . "%</b></font><br>";
                    break;
				case 'expbonus':
				...
				break;
                case 'massbonus':
                    $par_i .= "&nbsp;Масса: <font color=#BB0000>$plus<b>" . $modstroke . "</b></font><br>";
                    break;
			}			
		}
		if($ITEM['damage_mod']){
...
if (empty($_GET["i"])) {
    $_GET["i"] = (iconv("UTF-8", "utf-8", urldecode($_SERVER['QUERY_STRING'])) ? iconv("UTF-8", "utf-8", urldecode($_SERVER['QUERY_STRING'])) : urldecode($_SERVER['QUERY_STRING']));
}
$error = 0;
if(isset($_GET['auc'])){
