...
function create_account(account_type) {
    ...
    if (pwd == '') {
        ...
        alert('Поле "Подтвердите пароль" обязательно для заполнения.');
        return false;
    }
    else if (pwd != pwd2) {
...
function account_forgot_password(account_id, vcode) {
    ...
    if (account == '') {
        alert('Поле "Номер счета" обязательно для заполнения.');
        return false;
    }
...
function account_money_put(account_id) {
    ...
    if (isNaN(money)) {
        alert("Введите правильное количество денег.");
        return false;
    }
...
function account_money_transfer(account_id) {
    ...
    if (isNaN(account)) {
        alert("Введите правильный номер счёта.");
        return false;
    }
...
function account_change_password(account_id) {
    ...
    if (pwd == '') {
        alert('Поле "Новый пароль" обязательно для заполнения.');
        return false;
    }
    if (pwd2 == '') {
        alert('Поле "Повторить пароль" обязательно для заполнения.');
        return false;
    }
    if (pwd != pwd2) {
        alert('Поля "Новый пароль" и "Повторить пароль" должны совпадать.');
        return false;
    }
...
function account_change_email(account_id) {
    ...
    if (email == '') {
        alert('Поле "Новый E-mail" обязательно для заполнения.');
        return false;
    }
...
function account_pay(account_id) {
    if (!document.getElementById('pay_player').checked && !document.getElementById('pay_account').checked) {
...
function cell_forgot_password(cell_id, vcode) {
    ...
    if (cell == '') {
        alert('Поле "Номер ячейки" обязательно для заполнения.');
        return false;
    }
