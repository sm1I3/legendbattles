...
function writeuslov(e){	
	...
	if(el_sum > 0){
		...
		switch(e){
            case "0":
                txt = "Выберите сумму и срок кредита.";
                break;
            case "1":
                txt = "Выберите сумму кредита.<br>Срок кредита: 1 неделя";
                break;
            case "2":
                txt = "Выберите сумму кредита.<br>Срок кредита: 2 недели";
                break;
            case "3":
                txt = "Выберите сумму кредита.<br>Срок кредита: 4 недели";
                break;
            case "4":
                txt = "Выберите сумму кредита.<br>Срок кредита: 8 недель";
                break;
		}	
		el_us.innerHTML = txt;
	}
