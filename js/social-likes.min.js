...
(function (e) {
    ...
    function l(t) {
        function r(o) {
            ...
            t.fadeOut(n), i.off(s, r)
        }

        var i = e(document), s = "click touchstart keydown";
        i.on(s, r)
    }
    ...
    function c(e, t) {
        if (document.documentElement.getBoundingClientRect) {
            ...
            s.left < t ? e.css("left", t - s.left + r) : s.right > window.innerWidth - t && e.css("left", window.innerWidth - s.right - t + r), s.top < t ? e.css("top", t - s.top + i) : s.bottom > window.innerHeight - t && e.css("top", window.innerHeight - s.bottom - t + i), e.hide().css("visibility", "visible")
        }
        e.fadeIn(n)
    }

    var t = "social-likes__", n = "fast", r = {
        facebook: {
        ...
        vkontakte: {
            ...
            counter: function (t, n) {
                ...
                var s = i._.length;
                i._.push(n), e.ajax({url: u(t, {index: s}), dataType: "jsonp"})
            },
            ...
            click: function (t) {
                ...
                if (!n) {
                    ...
                    n = e(a('<form action="http://www.livejournal.com/update.bml" method="post" target="_blank" accept-charset="UTF-8"><input type="hidden" name="mode" value="full"><input type="hidden" name="subject" value="{title}"><input type="hidden" name="event" value="{html}"></form>', {
                        ...
                        html: r
                    })), this.widget.append(n), this._livejournalForm = n
                }
                n.submit()
            }
        },
        ...
        promises: {}, fetch: function (t, n, s) {
            ...
            return e.isFunction(a.counter) ? a.counter(l, f) : a.counterUrl && e.getJSON(l).done(function (t) {
                try {
                    var n = t;
                    e.isFunction(a.convertNumber) && (n = a.convertNumber(t)), f.resolve(n)
                } catch (r) {
                    f.reject(r)
                }
            }), o[n] = f.promise(), o[n]
    ...
    e.fn.socialLikes = function () {
        ...
        optionsMap: {
            pageUrl: {
                ...
                attr: "counters", defaultValue: "yes", convert: function (e) {
                    return e === "yes"
                }
            }
        }, init: function () {
            ...
            for (var t in this.optionsMap) {
                ...
                this.options[t] = this.container.data(n.attr) || (e.isFunction(n.defaultValue) ? e.proxy(n.defaultValue, this)() : n.defaultValue), e.isFunction(n.convert) && (this.options[t] = n.convert(this.options[t]))
            }
        }, initUserButtons: function () {
            !this.userButtonInited && window.socialLikesButtons && e.extend(r, socialLikesButtons), this.userButtonInited = !0
            ...
            u.prepend(e("<span>", {"class": f("icon", "single")})), i.append(u);
            var a = e("<li>", {"class": t + "close", html: "&times;"});
            r.append(a), this.number = 0, u.click(function () {
                return r.css({left: s, top: o}), c(r, 20), l(r), !1
            }), a.click(function () {
                r.fadeOut(n)
            }), this.wrapper = i
        }, updateCounter: function (e, t) {
            if (!t) return;
            this.number += t, this.getCounterElem().text(this.number)
        }, getCounterElem: function () {
            var n = this.wrapper.find("." + t + "counter_single");
            return n.length || (n = e("<span>", {"class": f("counter", "single")}), this.wrapper.append(n)), n
        }
    }, o.prototype = {
        init: function () {
            this.detectParams(), this.initHtml();
            if (this.options.pageCounters) if (this.options.counterNumber) this.updateCounter(this.options.counterNumber); else {
                var t = this.options.counterUrl ? {counterUrl: this.options.counterUrl} : {};
            ...
            for (var n = 0; n < t.length; n++) {
                var i = t[n];
                if (r[i]) {
                    this.service = i, e.extend(this.options, r[i]);
                    return
                }
            }
            ...
            var t = this.options, n = this.widget, r = !!t.clickUrl;
            n.removeClass(this.service), n.addClass(this.getElementClassNames("widget"));
            var i = n.find("a");
            i.length && this.cloneDataAttrs(i, n);
            var s = e(r ? "<a>" : "<span>", {"class": this.getElementClassNames("button"), text: n.text()});
            if (r) {
                var o = u(t.clickUrl, {url: t.pageUrl, title: t.pageTitle});
                s.attr("href", o)
            } else s.click(e.proxy(this.click, this));
            s.prepend(e("<span>", {"class": this.getElementClassNames("icon")})), n.empty().append(s), this.button = s
            ...
            t = parseInt(t, 10);
            if (!t) return;
            var n = e("<span>", {"class": this.getElementClassNames("counter"), text: t});
            this.widget.append(n), this.widget.trigger("counter.social-likes", t)
        }, click: function (t) {
            var n = this.options, r = !0;
            e.isFunction(n.click) && (r = n.click.call(this, t));
            if (r) {
                var i = u(n.popupUrl, {url: n.pageUrl, title: n.pageTitle});
                i = this.addAdditionalParamsToUrl(i), this.openPopup(i, {width: n.popupWidth, height: n.popupHeight})
            }
            return !1
