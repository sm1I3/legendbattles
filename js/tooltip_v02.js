        ...
        for (var i = 1; i < descr.length; i++) {
            ...
            switch (descr[i][0]) {
                ...
                case '24':
                    ...
                    break;
                case '25':
                    str_params += '<BR>Опыт PvP: +<B>' + descr[i][1] + '%</B>' + st;
                    break;
                case '26':
                    str_params += '<BR>Урон: ' + (parseInt(descr[i][1]) > 0 ? '+' : '') + '<B>' + descr[i][1] + '%</B>' + st;
                    break;
                case '33':
                    str_params += '<BR>Вес: +<B>' + descr[i][1] + '</B>' + st;
                    break;
                case '34':
                    str_params += '<BR>Вес: +<B>' + descr[i][1] + '%</B>' + st;
                    break;
                case '35':
                    str_params += '<BR>Максимальные HP: +<B>' + descr[i][1] + '</B>' + st;
                    break;
                case '36':
                    str_params += '<BR>Максимальные MP: +<B>' + descr[i][1] + '</B>' + st;
                    break;
                case '37':
                    str_params += '<BR>Восстановления HP: +<B>' + descr[i][1] + '%</B>' + st;
                    break;
                case '38':
                    str_params += '<BR>Восстановления MP: +<B>' + descr[i][1] + '%</B>' + st;
                    break;
                case '39':
                    str_params += '<BR>Минимальный урон: +<B>' + descr[i][1] + '</B>' + st;
                    break;
                case '40':
                    str_params += '<BR>Максимальный урон: +<B>' + descr[i][1] + '</B>' + st;
                    break;
                case '41':
                    str_params += '<BR>Наблюдательность: +<B>' + descr[i][1] + '%</B>' + st;
                    break;
                case '42':
                    str_params += '<BR>Опыт PvE: +<B>' + descr[i][1] + '%</B>' + st;
                    break;
                case '43':
                    str_params += '<BR>Время перехода: -<B>' + descr[i][1] + '%</B>' + st;
                    break;
            }
        }
