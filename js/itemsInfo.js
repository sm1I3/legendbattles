	...
	for (var str_val in str_pr){
		...
		switch(str_par[0]){
            ...
            case '1':
                ...
                break;
            case '2':
                str_params += "&nbsp;Долговечность: <b>" + str_par[1] + "</b><br />";
                break;
            case '3':
            ...
            case '70':
                ...
                break;
            case '71':
                str_params += "&nbsp;<font color=#BB0000>Коэффициент: " + ((str_par[1]) > 0 ? '+' : '') + "<b>" + str_par[1] + "%</b></font><br />";
                break;
		}
	}
	return str_params;
	...
	for (var str_val in str_pr){
		...
		switch(str_par[0]){
            ...
            case'34':
                ...
                break;
            case'35':
                str_params += "&nbsp;Сноровка: <b>" + str_par[1] + "</b><br />";
                break;
            case'36':
            ...
            case'72':
                ...
                break;
            case'73':
                str_params += "&nbsp;Звание: <b>" + str_par[1] + "</b><br />";
                break;
            case'74':
                str_params += "&nbsp;Взломщик: <b>" + str_par[1] + "</b><br />";
                break;
		}
	}
	return str_params;
