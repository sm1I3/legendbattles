...
function clan_sostav(pr, nick, lev, signst, sstatus, plnx, plid, fightid) {
    ...
    if (pr == 1) {
        priv = '<a href="javascript:parent.say_private(\'' + nick + '\')"><img src=http://img.legendbattles.ru/image/chat/private.gif width=11 height=12 border=0 align=absmiddle></a>';
        onoff = '<font color="#009933"><b>online</b></font>';
    }
    if (pr == 0) {
