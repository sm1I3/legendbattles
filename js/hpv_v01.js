...
ViewItem_sv = function(params){
	...
	for (var str_val in str_pr){
		...
		switch(str_par[0]){
			...
			case'30': str_params += "&nbsp;Мощь: "+((str_par[1])>0?'+':'')+"<b>"+str_par[1]+"</b><br />"; break;
			case'31': str_params += "&nbsp;Проворность: "+((str_par[1])>0?'+':'')+"<b>"+str_par[1]+"</b><br />"; break;
			case'32': str_params += "&nbsp;Везение: "+((str_par[1])>0?'+':'')+"<b>"+str_par[1]+"</b><br />"; break;
			case'33': str_params += "&nbsp;Здоровье: "+((str_par[1])>0?'+':'')+"<b>"+str_par[1]+"</b><br />"; break;
			case'34': str_params += "&nbsp;Разум: "+((str_par[1])>0?'+':'')+"<b>"+str_par[1]+"</b><br />"; break;
			...
			case'expbonus': str_params += "&nbsp;<font color=#BB0000>Бонус Опыта: "+((str_par[1])>0?'+':'')+"<b>"+str_par[1]+"%</font></b><br>";break;
			case'massbonus': str_params += "&nbsp;<font color=#BB0000>Масса: "+((str_par[1])>0?'+':'')+"<b>"+str_par[1]+"</font></b><br>";break;
		}
	}
	return str_params;
}
...
ViewItem_tr = function(params,massa,level,freemass){
	...
	for (var str_val in str_pr){
		...
		switch(str_par[0]){
			...
			case'30': str_params += "&nbsp;Мощь: <b>"+str_par[1]+"</b><br />"; break;
			case'31': str_params += "&nbsp;Проворность: <b>"+str_par[1]+"</b><br />"; break;
			case'32': str_params += "&nbsp;Везение: <b>"+str_par[1]+"</b><br />"; break;
			case'33': str_params += "&nbsp;Здоровье: <b>"+str_par[1]+"</b><br />"; break;
			case'34': str_params += "&nbsp;Разум: <b>"+str_par[1]+"</b><br />"; break;
			...
			case'expbonus': str_params += "&nbsp;Бонус Опыта:<font color=#BB0000> "+((str_par[1])>0?'+':'')+"<b>"+str_par[1]+"%</font></b><br>";break;
			case'massbonus': str_params += "&nbsp;Масса:<font color=#BB0000> "+((str_par[1])>0?'+':'')+"<b>"+str_par[1]+"</font></b><br>";break;
		}
	}
	return str_params;
}
