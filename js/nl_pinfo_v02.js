...
top_small = function(t)
{
    switch(t)
    {
        case 1: return '<a href="http://top.mail.ru/jump?from=1514311" target="_blank"><img src="http://d6.c2.ba.a0.top.mail.ru/counter?id=1514311;t=69;js=13;r='+r+';j='+navigator.javaEnabled()+';s='+sfo+';d='+dep+';rand='+Math.random()+'" border="0" height="31" width="38" style="filter:alpha(opacity=50);"></a>';
