...
return '<table cellpadding=3 cellspacing=1 border=0 align=center width=760 bgcolor=#e0e0e0><tr><td bgcolor=#f9f9f9><div align=center><img src=/images/weapon/'+img+' border=0></div></td><td width=100% bgcolor=#ffffff valign=top><table cellpadding=0 cellspacing=0 border=0 width=100%><tr><td bgcolor=#ffffff width=100%><font class=nickname><b>'+name+'</b></font><br><img src=/images/1x1.gif width=1 height=3></td><td><br><img src=/images/1x1.gif width=1 height=3></td></tr><tr><td colspan=2 width=100%><table cellpadding=0 cellspacing=0 border=0 width=100%><tr><td bgcolor=#D8CDAF width=50%><div align=center><font class=invtitle>свойства</font></div></td><td bgcolor=#B9A05C><img src=/images/1x1.gif width=1 height=1></td><td bgcolor=#D8CDAF width=50%><div align=center><font class=invtitle>требования</font></div></td></tr><tr><td bgcolor=#FCFAF3><font class=weaponch>'+((kolch==16)?'<b><font color=#cc0000>&nbsp;Можно одевать на кольчуги</font></b><br>':'')+blocks(block)+((hands==1)?'<b><font color=#cc0000>&nbsp;Двуручное оружие</font></b><br>':'')+'&nbsp;Цена: <b>'+price+' WMB</b><br>'+ViewItem_sv(sv)+'</font></td><td bgcolor=#B9A05C><img src=/images/1x1.gif width=1 height=1></td><td bgcolor=#FCFAF3><font class=weaponch>'+ViewItem_tr(tr,tr_level,tr_mass)+'</font></td></tr></table></td></tr></table></td></tr></table>';
}
