            ...
            left: function (a, b) {
                ...
                if (b.at[1] !== "center") {
                    ...
                    var e = b.my[1] === "top" ? -b.elemHeight : b.my[1] === "bottom" ? b.elemHeight : 0,
                        g = b.at[1] === "top" ? b.targetHeight : -b.targetHeight, h = -2 * b.offset[1];
    ...
    if (!c.offset.setOffset) {
        c.offset.setOffset = function (a, b) {
            if (/static/.test(c.curCSS(a, "position"))) a.style.position =
                "relative";
            var d = c(a), e = d.offset(), g = parseInt(c.curCSS(a, "top", true), 10) || 0,
    ...
    d.widget("ui.draggable", d.ui.mouse, {
        ...
        _generatePosition: function (a) {
            var b = this.options,
                ...
                f = /(html|body)/i.test(c[0].tagName), e = a.pageX, g = a.pageY;
    ...
    d.ui.plugin.add("draggable", "snap", {
        start: function () {
            ...
            for (var c = d(this).data("draggable"), f = c.options, e = f.snapTolerance, g = b.offset.left, n = g + c.helperProportions.width, m = b.offset.top, o = m + c.helperProportions.height, h = c.snapElements.length - 1; h >= 0; h--) {
                var i = c.snapElements[h].left, k = i + c.snapElements[h].width, j = c.snapElements[h].top,
                    l = j + c.snapElements[h].height;
                if (i - e < g && g < k + e && j - e < m && m < l + e || i - e < g && g < k + e && j - e < o && o < l + e || i - e < n && n < k + e && j - e < m && m < l + e || i - e < n && n < k + e && j - e < o &&
                    o < l + e) {
                    if (f.snapMode != "inner") {
                        var p = Math.abs(j - o) <= e, q = Math.abs(l - m) <= e, r = Math.abs(i - n) <= e,
                            s = Math.abs(k - g) <= e;
...
(function (d) {
    d.widget("ui.resizable", d.ui.mouse, {
        ...
        _respectSize: function (b) {
            var a = this.options, c = this.axis, e = k(b.width) && a.maxWidth && a.maxWidth < b.width,
    ...
    d.ui.plugin.add("resizable", "animate", {
        stop: function (b) {
            var a =
                    d(this).data("resizable"), c = a.options, e = a._proportionallyResizeElements,
    ...
    d.ui.plugin.add("resizable", "grid", {
        resize: function () {
            var b =
                    d(this).data("resizable"), a = b.options, c = b.size, e = b.originalSize, g = b.originalPosition,
                f = b.axis;
...
(function (d) {
    d.widget("ui.sortable", d.ui.mouse, {
        ...
        _refreshItems: function (a) {
            ...
            var b = this.items,
                c = [[d.isFunction(this.options.items) ? this.options.items.call(this.element[0], a, {item: this.currentItem}) : d(this.options.items, this.element), this]],
                e = this._connectWith();
...
(function (e) {
    e.widget("ui.menu", {
        _create: function () {
            ...
            this.deactivate();
            if (this.hasScroll()) {
                var c = b.offset().top - this.element.offset().top, d = this.element.attr("scrollTop"),
...
(function (a) {
    ...
    a.widget("ui.button", {
        options: {text: true, label: null, icons: {primary: null, secondary: null}}, _create: function () {
            ...
            var b = this, c = this.options, d = this.type === "checkbox" || this.type === "radio",
...
(function (c) {
    c.widget("ui.dialog", {
        options: {
            ...
            var a = this, b = a.options, d = b.title || a.originalTitle || "&#160;",
            ...
            this.element.css(a.height === "auto" ? {
                ...
                height: "auto"
            } : {minHeight: 0, height: Math.max(a.height - b, 0)}).show();
            this.uiDialog.is(":data(resizable)") && this.uiDialog.resizable("option", "minHeight",
                this._minHeight())
        }
    });
    c.extend(c.ui.dialog, {
        version: "1.8.1", uuid: 0, maxZ: 0, getTitleId: function (a) {
            a = a.attr("id");
            if (!a) {
                this.uuid += 1;
                a = this.uuid
    ...
    d.widget("ui.tabs", {
        options: {
            ...
            this.anchors.bind(b.event + ".tabs",
                function () {
                    var g = this, f = d(this).closest("li"), j = a.panels.filter(":not(.ui-tabs-hide)"),
    ...
    d.extend(J.prototype, {
        ...
        _updateAlternate: function (a) {
            ...
            if (b) {
                var c = this._get(a, "altFormat") ||
                    this._get(a, "dateFormat"), e = this._getDate(a),
        ...
        _generateHTML: function (a) {
            ...
            var c = this._get(a, "isRTL"), e = this._get(a, "showButtonPanel"), f = this._get(a, "hideIfNoPrevNext"),
                ...
                g = this._get(a, "showCurrentAtPos"), k = this._get(a, "stepMonths"), l = i[0] != 1 || i[1] != 1,
                u = this._daylightSavingAdjust(!a.currentDay ?
                    new Date(9999, 9, 9) : new Date(a.currentYear, a.currentMonth, a.currentDay)),
                j = this._getMinMaxDate(a, "min"), o = this._getMinMaxDate(a, "max");
            g = a.drawMonth - g;
            var m = a.drawYear;
            if (g < 0) {
                g += 12;
            ...
            var s = this._get(a, "dayNamesMin"), z = this._get(a, "monthNames"), v = this._get(a, "monthNamesShort"),
                p = this._get(a, "beforeShowDay"), w = this._get(a, "showOtherMonths"),
            ...
            for (var K = this._getDefaultDate(a), H = "", C = 0; C < i[0]; C++) {
                for (var L =
                    ...
                    for (var N = 0; N < A; N++) {
                        ...
                        for (t = 0; t < 7; t++) {
                            var F = p ? p.apply(a.input ? a.input[0] : null, [q]) : [true, ""], B = q.getMonth() != g,
        ...
        _generateMonthYearHeader: function (a, b, c, e, f, h, i, g) {
            var k = this._get(a, "changeMonth"), l = this._get(a, "changeYear"), u = this._get(a, "showMonthAfterYear"),
                j = '<div class="ui-datepicker-title">', o = "";
...
(function (b) {
    b.effects.blind = function (c) {
        return this.queue(function () {
            var a = b(this), g = ["position", "top", "left"], f = b.effects.setMode(a, c.options.mode || "hide"),
...
(function (e) {
    e.effects.bounce = function (b) {
        return this.queue(function () {
            var a = e(this), l = ["position", "top", "left"], h = e.effects.setMode(a, b.options.mode || "effect"),
                d = b.options.direction || "up", c = b.options.distance || 20, m = b.options.times || 5,
                i = b.duration || 250;
...
(function (b) {
    b.effects.clip = function (e) {
        return this.queue(function () {
            var a = b(this), i = ["position", "top", "left", "height", "width"],
...
(function (c) {
    c.effects.fold = function (a) {
        return this.queue(function () {
            var b = c(this), j = ["position", "top", "left"], d = c.effects.setMode(b, a.options.mode || "hide"),
                g = a.options.size || 15, h = !!a.options.horizFirst,
...
(function (c) {
    ...
    c.effects.size = function (b) {
        return this.queue(function () {
            var a = c(this), e = ["position", "top", "left", "width", "height", "overflow", "opacity"],
                g = ["position", "top", "left", "overflow", "opacity"], h = ["width", "height", "overflow"],
                i = ["fontSize"], f = ["borderTopWidth", "borderBottomWidth", "paddingTop", "paddingBottom"],
                k = ["borderLeftWidth", "borderRightWidth", "paddingLeft", "paddingRight"], p = c.effects.setMode(a,
                b.options.mode || "effect"), n = b.options.restore || false, m = b.options.scale || "both",
                l = b.options.origin, j = {height: a.height(), width: a.width()};
...
(function (c) {
    c.effects.slide = function (d) {
        return this.queue(function () {
            var a = c(this), h = ["position", "top", "left"], e = c.effects.setMode(a, d.options.mode || "show"),
...
(function ($) {
    ...
    $.extend($.fn.jGrowl.prototype, {
        defaults: {
        ...
        }, notifications: [], element: null, interval: null, create: function (message, o) {
            ...
            var notification = $('<div class="jGrowl-notification ui-corner-all' +
            ...
            if ($('div.jGrowl-notification:parent', self.element).size() > 1 && $('div.jGrowl-closer', self.element).size() == 0 && this.defaults.closer != false) {
                $(this.defaults.closerTemplate).addClass('jGrowl-closer ui-corner-all').addClass(this.defaults.theme).appendTo(self.element).animate(this.defaults.animateOpen, this.defaults.speed, this.defaults.easing).bind("click.jGrowl", function () {
...
(function ($) {
    var
        menu, shadow, trigger, content, hash, currentTarget;
    var defaults = {
        menuStyle: {
            listStyle: 'none',
            padding: '1px',
        ...
        itemHoverStyle: {border: '1px solid #AAA', color: '#000', backgroundColor: '#DDD'},
        leftClick: false,
        centered: false,
        eventPosX: 'pageX',
        eventPosY: 'pageY',
    ...
    $.fn.contextMenu = function (id, options) {
        ...
        hash.push({
            ...
            onHideMenu: options.onHideMenu || false,
            onShowMenu: options.onShowMenu || defaults.onShowMenu,
            eventPosX: options.eventPosX || defaults.eventPosX,
            eventPosY: options.eventPosY || defaults.eventPosY
        });
        var index = hash.length - 1;
        $(this).bind((options.leftClick ? 'click' : ($.browser.opera && $.browser.version > 10.50 ? 'contextmenu' : (!$.browser.opera ? 'contextmenu' : 'click'))), function (e) {
    ...
    function display(index, trigger, e, options) {
        var cur = hash[index];
        content = $('#' + cur.id).children().clone(true);
        content.css(cur.menuStyle).find('li').css(cur.itemStyle).hover(function () {
            $(this).css(cur.itemHoverStyle);
            if (document.menuTimer >= 0) clearTimeout(document.menuTimer);
            document.menuTimer = setTimeout(document.menuHide, 2000);
        }, function () {
            $(this).css(cur.itemStyle);
        }).find('img').css({verticalAlign: 'middle', paddingRight: '2px'});
        menu.html(content);
        menu.find('div').css(cur.titleStyle);
        if (!!cur.onShowMenu) {
            r = cur.onShowMenu(e, menu);
            if (!r) return;
            menu = r;
        }
        $.each(cur.bindings, function (id, func) {
            $('#' + id, menu).bind('click', function (e) {
                if (func(trigger, menu, this)) hide();
            });
        });
        var
            wWidth = $(window).width(), wHeight = $(window).height(), X = e[cur.eventPosX], Y = e[cur.eventPosY];
        if (options.centered) {
            X -= Math.floor(menu.width() / 2);
            Y += 10;
        }
        else {
            X += 4;
        ...
        if (X + menu.width() > wWidth) X -= X + menu.width() - wWidth + 5;
        if (Y + menu.height() > wHeight) Y -= menu.height();
        menu.css({'left': X, 'top': Y}).show();
        if (cur.shadow) shadow.css({width: menu.width(), height: menu.height(), left: X, top: Y}).show();
        $(document).one('click', hide);
        document.menuHide = hide;
        document.menuTimer = setTimeout(document.menuHide, 2000);
    }
