...
<?=$add_mf?>
    ...
    <a onclick="addItem_item_mf('table_mf', 'tr_mf', 'add_mf', mod_array); return false;" href="#">Добавить
        модификатор</a><br/>
<br />
...
<?=$add_rm?>
    ...
    <a onclick="addItem_item_rm('table_rm', 'tr_rm', 'add_rm', mod_array, 'td_rm'); return false;" href="#">Добавить
        группу модификаторов</a><br/>
<br />
...
<?=$add_rmb?>
    ...
    <a onclick="addItem_item_rmb('table_rmb', 'tr_rmb', 'add_rmb', mod_array, 'td_rmb'); return false;" href="#">Добавить
        группу модификаторов</a><br/>
<br />
<br />
...
<?=$add_aeff_mf?>
    ...
    <a onclick="addItem_item_mf('table_aeff_mf', 'tr_aeff_mf', 'add_aeff_mf', mod_array); return false;" href="#">Добавить
        модификатор</a><br/>
<br />
...
<?=$add_aeff_rm?>
    ...
    <a onclick="addItem_item_rm('table_aeff_rm', 'tr_aeff_rm', 'add_aeff_rm', mod_array, 'td_aeff_rm'); return false;"
       href="#">Добавить группу модификаторов</a><br/>
<br />
