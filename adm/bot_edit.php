        ...
        <table border="0" cellpadding="0" cellspacing="1">
            ...
            <tr>
                ...
                <td><input type="checkbox" name="is_active"
                           value="1" <?= ($bot['is_active'] == 1 ? 'checked="checked"' : '') ?> ></td>
            </tr>
            <tr>
                <td>Комментарий: &nbsp;</td>
                <td><input type="text" name="comment"
                           value="<?= (isset($bot['comment']) ? _htext($bot['comment']) : '') ?>"/></td>
            </tr>
            <tr>
                <td>Вероятность обыска: &nbsp;</td>
                <td><input type="text" name="search_possibility"
                           value="<?= (isset($bot['search_possibility']) ? _htext($bot['search_possibility']) : '100') ?>"/>
                </td>
            </tr>
            <tr>
                <td>Минус сколько уровней от бота дроп: &nbsp;</td>
                <td><input type="text" name="drop_level_dec"
                           value="<?= (isset($bot['drop_level_dec']) ? _htext($bot['drop_level_dec']) : '0') ?>"/></td>
            </tr>
            <tr>
                <td>Плюс сколько уровней от бота дроп: &nbsp;</td>
                <td><input type="text" name="drop_level_inc"
                           value="<?= (isset($bot['drop_level_inc']) ? _htext($bot['drop_level_inc']) : '0') ?>"/></td>
            </tr>
            <!--<tr>
...
<tr>
  ...
  <td><input type="text" name="align" value="<?= (isset($bot['align']) ? _htext($bot['align']) : '') ?>" /></td>
            ...
            <? foreach ($fields as $code => $name) { ?>
                <tr>
                    <td><?= $name ?>: &nbsp;</td>
                    <td><input name="<?= $code ?>" type="text" class="cms_fieldstyle1" id="<?= $code ?>"
                               value="<?= $bot[$code] ?>" size="10" maxlength="255" onchange="recalc_total_steps();"/>
                    </td>
                </tr>
            <? } ?>
        </table>
...
-->
        ...
        <table border="1" cellpadding="0" cellspacing="0" bordercolor="#C1E1EE" class="cms_table1" id="table_quest_qe">
            ...
            <? foreach ($slot_fields as $id => $sname) {
                ...
                if (isset($slots_weapon_steps[$id]) && $slots_weapon_steps[$id] != '') {
                    list($steps, $wea) = explode(':', $slots_weapon_steps[$id]);
                } else {
                    $wea = '';
                    $steps = '';
                }
                ...
                <tr>
                    ...
                    <td class="cms_middle"><input name="slots_name[<?= $id ?>]" type="text" class="cms_fieldstyle1"
                                                  value="<?= $name ?>" size="40" maxlength="255"/></td>
                    <td class="cms_middle"><input name="slots_img[<?= $id ?>]" type="text" class="cms_fieldstyle1"
                                                  value="<?= $img ?>" size="20" maxlength="255"/></td>
                    <td class="cms_middle"><?= createSelectFromArray('slots_weapon[' . $id . ']', $weapons, $wea, 'id="wea_' . $id . '" onchange="recalc_total_steps();"') ?></td>
                    <td class="cms_middle"><input name="slots_steps[<?= $id ?>]" type="text" class="cms_fieldstyle1"
                                                  value="<?= $steps ?>" id="steps_<?= $id ?>" size="5" maxlength="5"
                                                  onchange="recalc_total_steps();"/></td>
                </tr>
            <? } ?>
        </table>
        <br>
        ...
        <table border="0" cellpadding="0" cellspacing="1">
            <tr>
                <td>Удары:</td>
                <td><input type="text" name="bot_kicks[kicks]" value="<?= htmlspecialchars($bot_kicks['kicks']) ?>"
                           size="100"/></td>
            </tr>
            <tr>
                <td>Блоки:</td>
                <td><input type="text" name="bot_kicks[blocks]" value="<?= htmlspecialchars($bot_kicks['blocks']) ?>"
                           size="100"/></td>
            </tr>
            <tr>
                <td>Дополнительно:</td>
                <td><input type="text" name="bot_kicks[adds]" value="<?= htmlspecialchars($bot_kicks['adds']) ?>"
                           size="100"/></td>
            </tr>
        </table>
        <br/>
        ...
        <input name="cancel" type="submit"
               ...
               value="Отмена"/>
        <br><br>
        <input type="submit" name="update_tables" class="cms_button1" value="Обновить созданных ботов"
               style="width: 200px"
