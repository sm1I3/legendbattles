...
if (isset($_POST['service_name'])) {
    ...
    if ($service_type_id == '') {
        ...
        mysql_query($query);
        $service_type_id = mysql_insert_id();
    } else {
        $query = '
    ...
    mysql_query('DELETE FROM service_add WHERE service_type = '.intval($service_type_id));
...
if ($service_type_id == '') {
    ...
    $service_type = array();
    $res = mysql_query('select * from service_types where service_type = '.intval($service_type_id));
...
if ($service_type_id != '')
{
    $res = mysql_query('SELECT * FROM service_add WHERE service_type = '.intval($service_type_id));
    while($row = mysql_fetch_assoc($res))
        $add_services .= '
