...
<tr>
    ...
    <input type="checkbox" name="change_exp" id="change_exp"
           value="Y" <?= ($change_exp == 1 ? 'checked="checked"' : '') ?> /><label for="change_exp">Применять
        коэффициенты к опыту</label><br>
<br />
    Условия нападения: <input type="checkbox" name="check_attack_conditions"
