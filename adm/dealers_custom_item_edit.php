...
<input type="hidden" name="action" value="save" />
    <input type="submit" name="save" value="Сохранить"/>&nbsp;<input type="button" name="save" value="Отмена"
                                                                     onclick="document.location = 'dealers_custom_item_list.php'"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
            onclick="return confirm('Вы уверены что хотите удалть этот предмет?');" type="submit" name="delete"
            value="Удалить"/>
</form>