  ...
  for(var cou = 0; cou < ChatListU.length; cou++)
  {
    ...
    if (str_array[3].length>1)
    {
      ...
      if(sign_array[2].length>1)
        altadd=" ("+sign_array[2]+")";
      ss = "<img src=img/image/signs/"+sign_array[0]+" width=15 height=12 align=absmiddle title=\""+sign_array[1]+altadd+"\">&nbsp;";
    }
	//
    ...
    if (str_array[6] != '0')
     ...
     { 
       ...
       if(sign_array==0){align = "<img src=img/image/signs/1x1.gif width=16 height=16 align=absmiddle border=0 >";}else{
	   align = "<img src=img/image/signs/"+sign_array[0]+" width=16 height=16 align=absmiddle border=0 title=\""+sign_array[1]+"\">";}
     }
		 if (str_array[9] != '')
     { 
		 doblest_array = doblest_ar[str_array[13]].split(";");
	   doblest = "<img src=img/image/signs/rank/rank"+doblest_array[0]+".gif width=15 height=12 align=absmiddle border=0 title=\""+doblest_array[1]+"\">";
     }
