...
if($pers['clan_id']!='none'){
  ...
  if($pers['level'] >= 5){echo'<TD width="32%""><img src="/img/chat/ab7.gif" width="26" height="27" border="0" align="absmiddle" class="chatpostbut" onclick="useaction(\'auction-action\');" title="Аукцион"></TD>';}
