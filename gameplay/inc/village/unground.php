<?
	...
	if($cd[1]=='none'){
		echo'<tr><td align=center width=33% bgcolor=f5f5f5><b><a href="main.php?post_id=80&vcode=';echo scode();echo'"><font class=weaponchart>Войти в подземелье (1й уровень)</font></a></b></font></td></tr>';
	}
	else{
	...
	if($cd[2]=='none' and $clpod[$id-1]==$id){
		echo'<tr><td align=center width=33% bgcolor=f5f5f5><b><a href="main.php?post_id=80&vcode=';echo scode();echo'"><font class=weaponchart>Войти в подземелье (2й уровень)</font></a></b></font></td></tr>';
	}
