...
=
nickname > < b > <?echo $ITEM[name].($ITEM[modified]==1 ? " [ап]" : "");?><?php echo (($count>1)?' <font color="#CCCCCC">(<b>'.$count.' шт.</b>)</font>':''); ?><
...
<td bgcolor=#FCFAF3 width=50%><? if($ITEM[gift]==1 and empty($ITEM[gift_from])){echo '<font class=weaponch><img src="http://img.legendbattles.ru/image/gift/gift1.gif"/>&nbsp;Подарок!</font><br><br>'; }
