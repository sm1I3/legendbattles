...
$mage=0;
switch ($ud[1]) {
    case 0: $damage=1+$pl_damag*$s;break; //простой
	case 1: $damage=1+$pl_damag*1.3*$s;break; //усиленный
	case 2: $damage=($ud[2]*($pl_st[34]/250+1))*($pl_st[73]/100+1)*$s*0.7+$pl_damag/4;$ms[0]=" «Spirit Arrow»";$ms[1]=" магическим"; $mage=1;break;//спирит
	case 3: $damage=($ud[2]*($pl_st[34]/250+1))*($pl_st[73]/100+1)*$s+$pl_damag/4;$ms[0]=" «Mind Blast»";$ms[1]=" магическим"; $mage=1;break;//минд бласт
}
...
if($tg[hp]==0){$log.=",$logpl,\" нанес$psex[1] контрольный$ms[1] удар\",[6,$ud[0]],\"$ms[0] по трупу\",$logtg,\".\"";}
else{
