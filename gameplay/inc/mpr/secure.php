	...
	<div class="content">
		...
		<form action="main.php?mselect=secure" method="POST">
			...
			<div class="field">
				...
				<div class="info">
                    После смены e-mail персонаж не может проводить операции с финансами, передавать, дарить и выкидывать
                    предметы в течение 24 часов. Также пароль можно сменить только через 48 часов после смены e-mail.
				</div>
			</div>
		</form>
		<form action="main.php?mselect=secure" method="POST">
			...
			<div class="field">
				...
				<div class="info">
                    После смены пароля персонаж не может проводить операции с финансами, передавать, дарить и выкидывать
                    предметы в течение 24 часов. Также e-mail можно сменить только через 48 часов после смены пароля.
				</div>
			</div>
			<div class="save">
