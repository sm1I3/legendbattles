...
while ($row = mysqli_fetch_assoc($sql)) {
    ...
    ?>
    <tr>
        <td class=freetxt nowrap bgcolor=#<?= $col[$i] ?>><?= $row['time'] ?></td>
        <td class=freetxt nowrap align=center bgcolor=#<?= $col[$i] ?>><B><?= $row['action'] ?></B></td>
        <td class=freetxt align=center bgcolor=#<?= $col[$i] ?>><?= $row['ip'] ?></td>
        <td class=freetxt bgcolor=#<?= $col[$i] ?> align=center><?= $row['brouser'] ?></td>
    </tr>
