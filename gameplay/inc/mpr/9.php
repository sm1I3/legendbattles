...
<tr align=center><td align=center>Выставить Изумруд на продажу:</tr>
</table>
<table cellpadding=0 cellspacing=0 border=0 width=100% class=freemain align=center>
<tr><td class="tbl l b">Покупка Изумруда за Бронзу с 14-го уровня<td>Выводится 20 самых выгодных предложений</td></tr>
<tr><td class="tbl l b">Минимальная сумма для продажи: 30 <img src="<?=IMG;?>/razdor/emerald.png" width=14 title="Изумруд" height=14></td><td> Максимальная сумма для продажи: 1000 <img src="<?=IMG;?>/razdor/emerald.png" width=14 title="Изумруд" height=14></td></tr>
<tr><td class="tbl l b">Минимальный курс: 30 <img src=http://img.legendbattles.ru/image/gold.png width=14 height=14 valign=middle title=Золото></td><td> Максимальный курс: 50 <img src=http://img.legendbattles.ru/image/gold.png width=14 height=14 valign=middle title=Золото></td></tr>
<tr><td class="tbl l b">Налог с продажи: <font class=weaponch style="color:#dd0000">16%<td>Количество ставок: 1</td></tr>
<tr><td class="tbl l b">&nbsp;Продать: <img src="<?=IMG;?>/razdor/emerald.png" width=14 title="Изумруд" height=14>&nbsp;&nbsp;<input type=text class=guest name="gold_birja" title="Введите нужную сумму (ровное число) продаваемых Изумруда"></td></tr>
<tr><td class="tbl l b">&nbsp;Курс: <img src="http://img.legendbattles.ru/image/gold.png" width="14" height="14" valign="middle" title="Золото"><input type=text name=gold style="width: 60;"><img src="http://img.legendbattles.ru/image/silver.png" width="14" height="14" valign="middle" title="Золото"><input type=text name=silver style="width: 60;"><img src="http://img.legendbattles.ru/image/bronze.png" width="14" height="14" valign="middle" title="Золото"><input type=text name=bronze style="width: 60;"></td></tr>
<input type=hidden name="mselect" value="9">
<tr><td class="tbl l b"><input type=submit class=lbut value="Выставить на продажу" name="addbirja"></td></tr>
</td>
</tr>
</table>
</form>
...
<tr><td align=center><b><font class=weaponch style="color:#dd0000">Комиссия при удалении заявки составляет <font class=weaponch style="color:#dd0000"> 20% от суммы.</font></b></tr></td>
</table></FIELDSET>
