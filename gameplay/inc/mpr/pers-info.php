	...
	<div class="content">
		<form action="main.php?mselect=pers-info" method=POST>
			...
			<div class="field">
				...
				<div class="info">
                    Большая просьба указывать реальные имя и дату рождения.<br>Эти данные Вам могут пригодится для
                    восстановления героя.
				</div>
			</div>
			<div class="field">
			...
			<div class="field">
				...
				<div class="info">
                    Также требуется указывать реальные данные. Они могут Вам пригодится для восстановления героя, для
                    адаптации игры к Вашему региону, и не вызвать подозрений у представителей власти о Вашем
                    местоположении.
				</div>
			</div>
			<div class="field">
				...
				<div class="info">
                    Дополнительная информация о Вас (закрытая информация). Администрация рекомендует заносить сюда
                    информацию, которая может оправдать Вас перед представителями власти (игра с одного клуба, сестра,
                    брат, локальная сеть и так далее). Максимальная длина сообщения - 800 символов.
				</div>
			</div>
			<div class="field">
