...
<tr align=center><td align=center>ЕЩЁ не работает:</tr>
</table>
<table cellpadding=0 cellspacing=0 border=0 width=75% class=freemain align=center>
<tr><td class="tbl l b">Покупка Изумруд за LR с 14-го уровня<td>Выводится 20 самых выгодных предложений</td></tr>
<tr><td class="tbl l b">Минимальная сумма для продажи: 3 Изумруд</td><td> Максимальная сумма для продажи: 100 Изумруд</td></tr>
<tr><td class="tbl l b">Минимальный курс: 2000 LR</td><td> Максимальный курс: 5000 LR</td></tr>
<tr><td class="tbl l b">Налог с продажи: 3%<td>Количество ставок: 1</td></tr>
<tr><td class="tbl l b">&nbsp;Продать: Изумруд&nbsp;&nbsp;<input type=text class=guest name="gold_birja" title="Введите нужную сумму (ровное число) продаваемых DLR"></td></tr>
<tr><td class="tbl l b">&nbsp;Курс: LR&nbsp;&nbsp;<input type=text class=guest name="silver_birja" title="Введите курс LR за 1 DLR"></td></tr>
...
<tr><td align=center><b><font class=weaponch style="color:#dd0000">Комиссия при удалении заявки составляет 10% от суммы.</font></b></tr></td>
</table></FIELDSET>
