...
?>
<tr><td><form action=main.php?mselect=3 method=POST><input type=hidden name=post_id value=9>
<font class=proce>
<FIELDSET>
...
<table cellpadding=5 cellspacing=0 border=0 align=center><tr><td bgcolor=#CCCCCC>
...
?>
<tr>
<td colspan=6 align=center><input type=image src=http://img.legendbattles.ru/image/changeim.gif width=106 height=15 border=0></td>
</tr>
</table></td></tr></table></td></tr></form>
<? } if($col[1]>0){?>
<td colspan=2><form action=main.php?mselect=3 method=POST><input type=hidden name=post_id value=10><input type=hidden name=act_id value=2><input type=hidden name=vcode value=<?=scod()?>><table cellpadding=15 cellspacing=0 border=0 align=center><tr>
 <td><div align=center><img src=http://img.legendbattles.ru/image/obrazy/<?=$player['sex']?>_0.gif width=115 height=255 border=0><br><input type=radio name=selectob value=0></div></td>
 <td><div align=center><img src=http://img.legendbattles.ru/image/obrazy/<?=$player['sex']?>_1.gif width=115 height=255 border=0><br><input type=radio name=selectob value=1></div></td>
 <td><div align=center><img src=http://img.legendbattles.ru/image/obrazy/<?=$player['sex']?>_2.gif width=115 height=255 border=0><br><input type=radio name=selectob value=2></div></td>
 <td><div align=center><img src=http://img.legendbattles.ru/image/obrazy/<?=$player['sex']?>_3.gif width=115 height=255 border=0><br><input type=radio name=selectob value=3></div></td>
 </tr>
 <tr>
 <td><div align=center><img src=http://img.legendbattles.ru/image/obrazy/<?=$player['sex']?>_4.gif width=115 height=255 border=0><br><input type=radio name=selectob value=4></div></td>
 <td><div align=center><img src=http://img.legendbattles.ru/image/obrazy/<?=$player['sex']?>_5.gif width=115 height=255 border=0><br><input type=radio name=selectob value=5></div></td>
 <td><div align=center><img src=http://img.legendbattles.ru/image/obrazy/<?=$player['sex']?>_6.gif width=115 height=255 border=0><br><input type=radio name=selectob value=6></div></td>
 <td><div align=center><img src=http://img.legendbattles.ru/image/obrazy/<?=$player['sex']?>_7.gif width=115 height=255 border=0><br><input type=radio name=selectob value=7></div></td>
 </tr>
<? /*
 ...
 */?>
 <tr><td colspan=4><div align=center><input type=image src=http://img.legendbattles.ru/image/changeim.gif width=106 height=15 border=0></div></td></tr></table>
</td></tr></form>
<?php
}
