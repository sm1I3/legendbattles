...
if($pupil){
	...
	echo'<form method="post" action="main.php?mselect=teach">
				  ...
				  <font class="weaponch">
					<p>
					  <i class="gray" style="text-align:left;">
						<b class="ma">Справка:</b> Предложить стать наставником можно любому персонажу ниже 10ого уровня. Предложение бесплатно, однако, если персонаж примет его, то с вашего счёта спишется <b>20 Меди</b>, а ученик получит <b>10 меди</b> и <b>+50% опыта за бои</b> в награду. Обучать можно лишь одного персонажа. Если ваш ученик достигнет 10ого уровня вы получите в награду <b>500 LR</b>, <b>0.15 $</b> и <b>100 Мирного опыта</b>!
					  </i>
					</p>
				  </font>
				</td>
...
echo '<center>Вы уже обучили <b>' . $player['good_pupils_count'] . '</b> персонажей.<br><i class=ma>За каждого 5ого вы будете дополнительно получать по 2000 меди</i></center>
</div></div>';