...
<tr><td colspan=2 bgcolor=#F9f9f9><div align=center><font class=inv><b> У Вас с собой <?=lr($player[nv])?> и вещей массой: <?=$plstt[71]?> Максимальный вес: <?=$mass?></b></div></td></tr>
<tr>
	<td width=100% align=center  bgcolor=#F9f9f9><a href="?art=0"><?=(!$_GET['art']?'<b>':'')?>модификация простых предметов<?=(!$_GET['art']?'</b>':'')?></a></td>
