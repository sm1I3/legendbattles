...
<tr><td ><?$locname = mysql_fetch_array(mysqli_query($GLOBALS['db_link'],"SELECT * FROM `loc` WHERE `id`='".$player['loc']."' LIMIT 1;"));?><fieldset><legend align="center"><b><font color="gray"><?=$locname['loc'];?></font></b></legend><img src=http://w2.dwar.ru/info/pictures/image/yarmarka_mag.jpg width=960 height=260 border=0></fieldset></td></tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align=center>
		<input type="button" class="lbut" onclick="location='?weapon_category=w4'" value="Оружие" />
		...
		<input type="button" class="lbut" onclick="location='?weapon_category=w999'" value="Эликсиры" />
		<input type="button" class="lbut" onclick="location='?weapon_category=w70'" value="Мази" />
...
if($num>0){?>
<table cellpadding=0 cellspacing=0 border=0 width=100%><tr><td bgcolor=#e0e0e0><table cellpadding=3 cellspacing=1 border=0 width=100%><tr><td colspan=2 bgcolor=#F9f9f9><div align=center><font class=inv><b> У Вас с собой <?=$player[nv]?> и вещей массой: <?=$plstt[71]?> Максимальный вес: <?=$mass?></b></div></td></tr>
<?
$freemass=$plstt[71];
...
?>
<tr><td bgcolor=#f9f9f9><div align=center><img src=/img/image/weapon/<?=$ITEM[gif]?> border=0></div></td><td width=100% bgcolor=#ffffff valign=top><table cellpadding=0 cellspacing=0 border=0 width=100%><tr><td bgcolor=#ffffff width=100%><font class=nickname><b>
<? 
if($ITEM['dd_price']==0){
