...
<tr>
    <td width="34%" bgcolor="#f5f5f5" align="center"><a href="#" onClick="location='?weapon_category=snast'"
                                                        title=""><font class="zaya"><b>Лавка инструментов</b></font></a>
    </td>
    <td width="33%" bgcolor="#f5f5f5" align="center"><a href="#" onClick="location='?weapon_category=sellles'" title=""><font
                    class="zaya"><b>Переработка леса</b></font></a></td>
    <td width="33%" bgcolor="#f5f5f5" align="center"><a href="#" onClick="location='?weapon_category=sell'"
                                                        title=""><font class="zaya"><b>Сдать материалы</b></font></a>
    <td width="33%" bgcolor="#f5f5f5" align="center"><a href="#" onClick="location='?weapon_category=sellder'" title=""><font
                    class="zaya"><b>Плотник</b></font></a></td>
</td></tr>
<tr><td colspan=4>
<? if(isset($_GET['weapon_category'])){
...
elseif(isset($_GET['weapon_category']) and $_GET['weapon_category']=='sell'){
    ...
    <table cellpadding=5 cellspacing=1 border=0 width=100%>
        <tr>
            <td bgcolor=#F5F5F5 align=center colspan=2><font class=inv><b>Нет товаров в данной категории.</b></font>
            </td>
        </tr>
<? }?>
</table>
