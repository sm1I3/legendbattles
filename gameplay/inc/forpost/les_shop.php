...
<tr><td colspan=4><?$locname = mysqli_fetch_assoc(mysqli_query($GLOBALS['db_link'],"SELECT * FROM `loc` WHERE `id`='".$player['loc']."' LIMIT 1;"));?><div class="block info"><div class="header">
		<span><?=$locname['loc'];?></span>
	</div><img src=/img/image/gameplay/lesorubka.jpg width=760 height=255 border=0></td></tr>
<!---->
...
<td width="33%" bgcolor="#f5f5f5" align="center"><a href="#" onClick="location='?weapon_category=sellles'" title=""><font class="zaya"><b>Переработка леса</b></font></a></td>
...
<td width="33%" bgcolor="#f5f5f5" align="center"><a href="#" onClick="location='?weapon_category=sellder'" title=""><font class="zaya"><b>Плотник</b></font></a></td>
</td></tr>
<tr><td colspan=4>
<? if(isset($_GET['weapon_category'])){
switch($_GET['weapon_category']){
	case 'snast': $querywep=" AND type='w68' AND slot='3'"; break;
}
