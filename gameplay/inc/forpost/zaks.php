...
<tr><th colspan=4 align=center>Дворец Бракосочетаний<tr><td><img src=/img/image/gameplay/other/mar_city1.jpg width=760 height=255 border=0></td></tr></th></tr>
<tr><td><img src=/img/image/1x1.gif width=1 height=10></td></tr>
</table>

<table class=tbl1 border=0 align=center width=760>
<tr><th colspan=4 align=center>Женится<tr><td>
...
?>
<table class=tbl1 border=0 align=center width=760>
<tr><th colspan=4 align=center>Развести<tr><td>
<center>
...
<br>
<table class=tbl1 border=0 align=center width=760>
<tr><th colspan=4 align=center>Активация<tr><td>
<table width=100%>
<?while ($zk = mysqli_fetch_assoc($zaks)) {
?>
<tr><td>Жених:   <font color=green><?=$zk['male']?></td><td>Жена:  <font color=green><?=$zk['female']?></td><td><form action="" method="POST"><input type="hidden" name="id" value="<?=$zk['id']?>"><select name="status"><option value="0">Ожидает подтверждения</option><option value="1"<?=(($zk['status']==1)?' selected':'')?>>Активна</option></select></td><td><input type="submit" value="Сохранить"></form></td></tr>
<?php	
}?>
</table></FIELDSET><?}?></i></font></font></b></div></td></tr>
<tr><td><img src=http://image.neverlands.ru/1x1.gif width=1 height=3></td></tr>
<tr><td>
<div align=right>
