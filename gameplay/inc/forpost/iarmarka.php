...
<div class="block market">
    ...
    <div class="content" style="text-align:center">
        ...
        <div>
            <form method=post>
                ...
                <input type=text size=2 name=max_nv
                       value="<?= (($_SESSION['max_nv'] == '0') ? '' : $_SESSION['max_nv']) ?>"><b></b> сортировка по
        ...
        /
        tr > < tr > < td ><? if (isset($_GET['weapon_category'])) {
