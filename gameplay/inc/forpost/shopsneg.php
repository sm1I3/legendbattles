    ...
    <tr>
        <td>
            ...
            <table cellpadding=0 cellspacing=1 border=0 align=center width=100%>
                <tr align=center>
                    <td align=center><? $locname = mysqli_fetch_array(mysqli_query($GLOBALS['db_link'], "SELECT * FROM `loc` WHERE `id`='" . $player['loc'] . "' LIMIT 1;")); ?>
                        <fieldset>
                            <legend align="center"><b><font color="gray"><?= $locname['loc']; ?></font></b></legend>
                            <img src=/img/image/shops/tower4.jpg width=760 height=255 border=0 align=center></fieldset>
                    </td>
                </tr>
                <!---->
                <tr>
                ...
                <tr>
                    <td>
                        <div align=center>
                            <input input type=image src=/img/image/gameplay/shop/helm.gif
                                   onClick="location='?weapon_category=w23'" title="Шлемы" width=40 height=50><input
                                    ...
                                    onClick="location='?weapon_category=w19'" title="Доспехи" width=40 height=50>
                            <input type=image src=/img/image/gameplay/invent/8.gif
                                   onClick="location='?weapon_category=w61'" title="Приманки" border="0">
                            <input type=image src=/img/image/gameplay/invent/1.gif
                                   onClick="location='?weapon_category=w66'" title="Алхимия" border="0">
                            <input type=image src=/img/image/gameplay/invent/cat/21.gif
                                   onClick="location='?weapon_category=w0'" title="Зелья" border="0">
                                    ...
                                    <table cellpadding=3 cellspacing=1 border=0 width=100%>
                                        <tr>
                                            <td colspan=2 bgcolor=#F9f9f9>
                                                <div align=center><font class=inv><b> У Вас с собой <?= $player[sneg] ?>
                                                            Снежинки и вещей массой: <?= $plstt[71] ?> Максимальный
                                                            вес: <?= $mass ?></b></div>
                                            </td>
                                        </tr>
                                        <?
                                            ...
                                            <tr>
                                                <td bgcolor=#f9f9f9>
                                                    <div align=center><img
                                                                src=/img/image/weapon/<?= $ITEM[gif] ?> border=0></div>
                                                </td>
                                                <td width=100% bgcolor=#ffffff valign=top>
                                                    <table cellpadding=0 cellspacing=0 border=0 width=100%>
                                                        <tr>
                                                            <td bgcolor=#ffffff width=100%><font
                                                                        class=nickname><b><? if ($player[sneg] >= $ITEM[price] AND $ITEM[kol] > 0 and $m != 0) { ?>
                                                                            <input type=button class=invbut
                                                                                   onclick="location='main.php?post_id=116&wsuid=<?= $ITEM[id] ?>&vcode=<?= scod() ?>'"
                                                                                   value="купить"> <? }
                                                                        ...
                                                                        )<br><img src=/img/image/1x1.gif width=1
                                                                                  height=3></td>
                                                                ...
                                                                <table cellpadding=0 cellspacing=0 border=0 width=100%>
                                                                    <tr>
                                                                        <td bgcolor=#D8CDAF width=50%>
                                                                            <div align=center><font class=invtitle>свойства
                                                                            </div>
                                                                        </td>
                                                                        <td bgcolor=#B9A05C><img src=/img/image/1x1.gif
                                                                                                 width=1 height=1></td>
                                                                        <td bgcolor=#D8CDAF width=50%>
                                                                            <div align=center><font class=invtitle>требования
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td bgcolor=#FCFAF3><font class=weaponch>&nbsp;Цена:
                                                                                <b><? if ($ITEM[price] > $player[sneg]) {
                                                                                        echo "<font color=#cc0000>$ITEM[price] Снежинки</font>";
                                                                                    } else {
                                                                                        echo $ITEM[price] . " Снежинки";
                                                                                    } ?></b><?php ?><br>
