    ...
    <td><font class="proce">
      <fieldset>
        ...
        <table cellpadding="0" cellspacing="0" border="0" align="center" width="645">
          <tr>
            <td width="760" height="228" style="position:relative;" background="/img/image/cities/haos2.png" usemap="#links"><img src="/img/image/cities/haos2.png" width="760" height="228" border="0" usemap="#Map" /></td>
          </tr>
        </table>
      </fieldset>
    </font></td>
