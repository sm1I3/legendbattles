...
<tr><th colspan=4 align=center>Казино</th></tr>

<tr><td>

<div id="tooltip"></div><table cellpadding=0 cellspacing=0 border=0 align=center width=760><tr><td><img src=http://image.neverlands.ru/1x1.gif width=1 height=2></td></tr><tr><td bgcolor=#CCCCCC><table cellpadding=4 cellspacing=1 border=0 width=100%></tr><tr>
</tr>
</table>
<tr>
 <td bgcolor="#FFFFFF">
...
function new_game () {
        ...
        <center>
        Ставка: <SELECT class=lbut name=type><OPTION value='1' selected>100 LR<OPTION value='2'>250 LR<OPTION value='3'>1000 LR<OPTION value='4'>5000 LR<OPTION value='5'>10000 LR</OPTION></SELECT><p><input type=submit value='Начать игру' class=lbut>
        </center>
        </FIELDSET>
        </form>
        </td>
...
<center><?php
if($player['clan_gif']!=''){echo"<img src=/img/image/signs/".$player['clan_gif'].">";}echo"<b>".$player['login']."</b>[".$player['level']."]<a href='/pinfo.cgi?".$player['login']."' target='_blank'><img src='/img/image/chat/info.gif' width='11' height='12' border='0' align='absmiddle'></a>";
...
?> <input type=button value='Новая игра' class=lbut onclick='window.location.href="main.php?kazino=1&tmp="+Math.random();""'>
</center>
</FIELDSET>
</form>
</td>
