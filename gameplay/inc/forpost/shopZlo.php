                                    ...
                                    <table cellpadding=3 cellspacing=1 border=0 width=100%>
                                        <tr>
                                            <td colspan=2 bgcolor=#F9f9f9>
                                                <div align=center><font class=inv><b> У Вас с собой <?= $player[Zlo] ?>
                                                            Репутация зла и вещей массой: <?= $plstt[71] ?> Максимальный
                                                            вес: <?= $mass ?></b></div>
                                            </td>
                                        </tr>
                                        <?
                                                    ...
                                                    <table cellpadding=0 cellspacing=0 border=0 width=100%>
                                                        <tr>
                                                            <td bgcolor=#ffffff width=100%><font
                                                                        class=nickname><b><? if ($player[Zlo] >= $ITEM[price] AND $ITEM[kol] > 0 and $m != 0) { ?>
                                                                ...
                                                                <table cellpadding=0 cellspacing=0 border=0 width=100%>
                                                                    ...
                                                                    <tr>
                                                                        <td bgcolor=#FCFAF3><font class=weaponch>&nbsp;Цена:
                                                                                <b><? if ($ITEM[price] > $player[Zlo]) {
                                                                                        echo "<font color=#cc0000>$ITEM[price] Репутация зла</font>";
                                                                                    } else {
                                                                                        echo $ITEM[price] . " Репутация зла";
                                                                                    } ?></b><?php ?><br>
