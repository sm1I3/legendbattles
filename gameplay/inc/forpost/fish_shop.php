...
<tr><td colspan=3><?$locname = mysqli_fetch_assoc(mysqli_query($GLOBALS['db_link'],"SELECT * FROM `loc` WHERE `id`='".$player['loc']."' LIMIT 1;"));?><div class="block info">
	<div class="header">
...
<tr>
    <td width="33%" bgcolor="#f5f5f5" align="center"><a href="#" onClick="location='?weapon_category=priman'"
                                                        title=""><font class="zaya"><b>Приманки для рыбы</b></font></a>
    </td>
    <td width="34%" bgcolor="#f5f5f5" align="center"><a href="#" onClick="location='?weapon_category=snast'"
                                                        title=""><font class="zaya"><b>Снасти</b></font></a></td>
    <td width="33%" bgcolor="#f5f5f5" align="center"><a href="#" onClick="location='?weapon_category=sell'"
                                                        title=""><font class="zaya"><b>Сдать рыбу</b></font></a>
</td></tr>
<tr><td bgcolor=#CCCCCC width=100% colspan=3><img src=/img/image/1x1.gif width=1 height=1 width=40 height=50></td></tr><!---->
<tr><td colspan=3 bgcolor="#f5f5f5" width="100%">
        <div align=center><a href="javascript:parent.helpwin('legendbattles.ru/help.php?fish=1')" target="_blank">Таблица
                дохода от рыбалки (27.02.2013)</a></div>
</td></tr>
<tr><td colspan=3>
<? if(isset($_GET['weapon_category'])){
switch($_GET['weapon_category']){
	case 'priman': $querywep=" AND type='w69' AND slot='0'"; break;
	case 'snast': $querywep=" AND type='w69' AND slot='3'"; break;
}
