                ...
                <tr>
                    <td colspan=4><? $locname = mysqli_fetch_assoc(mysqli_query($GLOBALS['db_link'], "SELECT * FROM `loc` WHERE `id`='" . $player['loc'] . "' LIMIT 1;")); ?>
                        <fieldset>
                            ...
                            <img src=/img/image/gameplay/ci_m.jpg width=760 height=255 border=0></fieldset>
                    </td>
                </tr>
                <tr>
                    <td bgcolor=#cccccc>
                        <table cellpadding=5 cellspacing=1 border=0 align=center width=100%>
                            <tr>
                                <td width="25%" bgcolor="#f5f5f5" align="center"><a href="#"
                                                                                    onClick="location='?weapon_category=1'"
                                                                                    title=""><font class="zaya"><b>Заявка
                                                на Лицензию</b></font></a>
                                </td>
                                <td width="25%" bgcolor="#f5f5f5" align="center"><a href="#"
                                                                                    onClick="location='?weapon_category=2'"
                                                                                    title=""><font class="zaya"
                                                                                                   style="color: red;"><b>Заявка
                                                на
                                                Пропуск</b></font></a></td>
                                <td width="25%" bgcolor="#f5f5f5" align="center"><a href="#"
                                                                                    onClick="location='?weapon_category=3'"
                                                                                    title=""><font class="zaya"><b>Просмотр
                                                Лицензий и
                                                пропусков</b></font></a></td>
                                <td width="25%" bgcolor="#f5f5f5" align="center"><a href="#"
                                                                                    onClick="location='?weapon_category=4'"
                                                                                    title=""><font class="zaya"><b>Регистрация
                                                бракосочетаний</b></font></a></td>
                            </tr>
                            <? if ($player['clan'] == 'Life' or $player['clan'] == 'Мэрия города') { ?>
                                <tr>
                                    <td bgcolor="#f5f5f5" align="center" colspan=4><font class=proceg><b>только для
                                                сотрудников
                                                мэрии</b></font></td>
                                </tr>
                                <tr>
                                    <td width="25%" bgcolor="#f5f5f5" align="center"><a href="#"
                                                                                        onClick="location='?adm_category=1'"
                                                                                        title=""><font
                                                    class="zaya"><b>Выдача лицензий</b></font></a></td>
                                    <td width="25%" bgcolor="#f5f5f5" align="center"><a href="#"
                                                                                        onClick="location='?adm_category=2'"
                                                                                        title=""><font
                                                    class="zaya"><b>Контроль товара в магазинах</b></font></a></td>
                                    <td width="25%" bgcolor="#f5f5f5" align="center"><a href="#"
                                                                                        onClick="location='?adm_category=3'"
                                                                                        title=""><font
                                                    class="zaya"><b>Состав мэрии</b></font></a></td>
                                    <td width="25%" bgcolor="#f5f5f5" align="center"><a href="#"
                                                                                        onClick="location='?adm_category=4'"
                                                                                        title=""><font
                                                    class="zaya" style="color: red;"><b>Заявки на
                                                    бракосочетание</b></font></a></td>
                                </tr>
                            <? } ?>
                        </table>
                </tr>
