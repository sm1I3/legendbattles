...
<tr><td colspan=4><?$locname = mysqli_fetch_assoc(mysqli_query($GLOBALS['db_link'],"SELECT * FROM `loc` WHERE `id`='".$player['loc']."' LIMIT 1;"));?><fieldset><legend align="center"><b><font color="gray"><?=$locname['loc'];?></font></b></legend><img src=/img/image/gameplay/lesorubka.jpg width=760 height=255 border=0></fieldset></td></tr>
<!---->
<tr><td bgcolor=#f5f5f5 colspan=4><?php 
...
?></td></tr>
<tr><td bgcolor=#CCCCCC width=100% colspan=4><img src=/img/image/1x1.gif width=1 height=1 width=40 height=50></td></tr><!---->

<tr>
<td width="34%" bgcolor="#f5f5f5" align="center"><a href="#" onClick="location='?weapon_category=snast'" title=""><font class="zaya"><b>Лавка инструментов</b></font></a></td>
<td width="33%" bgcolor="#f5f5f5" align="center"><a href="#" onClick="location='?weapon_category=sellles'" title=""><font class="zaya"><b>Переработка руды</b></font></a></td>
<td width="33%" bgcolor="#f5f5f5" align="center"><a href="#" onClick="location='?weapon_category=sellder'" title=""><font class="zaya"><b>Переработка металла</b></font></a>
<td width="33%" bgcolor="#f5f5f5" align="center"><a href="#" onClick="location='?weapon_category=sell'" title=""><font class="zaya"><b>Сдать материалы</b></font></a>
</td></tr>
<tr><td colspan=4>
<? if(isset($_GET['weapon_category'])){
switch($_GET['weapon_category']){
	case 'snast': $querywep=" AND type='w70' AND slot='3'"; break;
}
...
<div align=center><font class=inv><b> У Вас с собой <?=$player[nv]?> и вещей массой: <?=$plstt[71]?> Максимальный вес: <?=$mass?></b></div></td></tr>
<?
	$freemass=$plstt[71];
	$i=0;
