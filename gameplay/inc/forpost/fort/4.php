<div style="text-align:center;font-weight:bold;padding: 0 0 20 0px">Доступно
    покупок: <?php echo $Fort['market']; ?></div>
...
<table class=tab_no style="width:auto;">
    ...
    <tr>
        <td style="padding:0 10 20 0px;">
            <div style="padding:3 3 3 3px;">
        ...
        <td style="padding:5 0 20 0px;">
            ...
            <div style="padding:0 0 1 0px;"><b>Цена:</b> {price} рак. <a href="?buy={key}"
                                                                         onclick="return confirm('Действительно покупаем {name} за {price} рак.?');">купить</a>
            </div>
        </td>
    </tr>
    <!-- END items_list -->
