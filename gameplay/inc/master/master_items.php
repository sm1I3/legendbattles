				...
				<table cellpadding=0 cellspacing=0 border=0 width=100%>
					<tr>
                        ...
                        <td bgcolor=#D8CDAF width=50% colspan=3>
                            <div align=center><font class=invtitle><font color=#000000>Параметры и свойства</font></div>
                        </td>
							<td bgcolor=#B9A05C><img src=http://img.legendbattles.ru/image/1x1.gif width=1 height=16></td>
                        <td bgcolor=#D8CDAF width=50% colspan=3>
                            <div align=center><font class=invtitle><font color=#cc0000>Требования</font></div>
                        </td>
					</tr>
