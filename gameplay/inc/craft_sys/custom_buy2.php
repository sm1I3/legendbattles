<?
	...
	if(mysqli_num_rows($chrecipe)>0){
		...
		if($player['nv']>=$chrecipe['price'] and in_array($chrecipe['id'],$koldyn_rec)==false){
			$message=1;include ($_SERVER["DOCUMENT_ROOT"]."/gameplay/inc/craft_sys/custom_messages2".".php");
