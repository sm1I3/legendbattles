...
if (mysqli_num_rows($query) > 0) {
	...
	<table cellpadding=10 cellspacing=0 border=0 width=100%>
        ...
        echo "<font class=weaponch><b>Название артефакта:</b> " . $row['name'] . "&nbsp;&nbsp;<br><b>Статус:</b>";
        if ($row['compl'] == 0) {
            echo "<font style='color:red'> заявка не выполнена</font></font>";
        } else if ($row['compl'] == 1) {
            echo "<font style='color:green'>заявка выполнена</font></font>";
        }
