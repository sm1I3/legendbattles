                    ...
                    var b = function () {
                        ...
                        function r() {
                            for (e = 0; e < f.length; e++) {
                                ...
                                f.eq(e).parent().is("optgroup") && (void 0 !== f.eq(e).parent().attr("class") && (c = " " + f.eq(e).parent().attr("class")), a = '<li class="' + b + d + " option" + c + '">' + f.eq(e).text() + "</li>", f.eq(e).is(":first-child") && (a = '<li class="optgroup' + c + '">' + f.eq(e).parent().attr("label") + "</li>" + a));
                                w += a
                            }
                        }
                        ...
                        if (a.is("[multiple]")) {
                            ...
                            var j = d("ul", h), g = d("li", h).attr("unselectable", "on").css({
                                "-webkit-user-select": "none",
                                "-moz-user-select": "none",
                                "-ms-user-select": "none",
                                "-o-user-select": "none",
                                "user-select": "none"
                            }), t = a.attr("size"), u = j.outerHeight(), x = g.outerHeight();
                            ...
                            if (a.is(":disabled")) k.addClass("disabled"); else {
                                r();
                                ...
                                d(document).on("click", function (a) {
                                    !d(a.target).parents().hasClass("selectbox") && "OPTION" != a.target.nodeName && (c.hide().find("li.sel").addClass("selected"), k.removeClass("focused opened"))
                                })
                            }
                        }
                    };
