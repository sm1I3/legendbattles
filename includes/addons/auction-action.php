                ...
                <tr>
                    <td bgcolor="#cccccc">
                        <table cellpadding="1" cellspacing="1" width="100%" border="0">
                            <tr>
                                <td bgcolor="#<?php echo(($_GET['addid'] == 'lots' or $_GET['addid'] == '') ? 'FFFFFF' : 'F0F0F0'); ?>"
                                    width="25%">
                                    <div align="center"><a href="?useaction=auction-action&addid=lots" class="nickname"><font
                                                    class="nickname"><b>Аукцион</b></font></a></div>
                                </td>
                                <td bgcolor="#<?php echo(($_GET['addid'] == 'mylots') ? 'FFFFFF' : 'F0F0F0'); ?>"
                                    width="25%">
                                    <div align="center"><a href="?useaction=auction-action&addid=mylots"
                                                           class="nickname"><font class="nickname"><b>Мои
                                                    лоты</b></font></a></div>
                                </td>
                                <td bgcolor="#<?php echo(($_GET['addid'] == 'newlots') ? 'FFFFFF' : 'F0F0F0'); ?>"
                                    width="25%">
                                    <div align="center"><a href="?useaction=auction-action&addid=newlots"
                                                           class="nickname"><font class="nickname"><b>Новый
                                                    лот</b></font></a></div>
                                </td>
                            </tr>
                        </table>
