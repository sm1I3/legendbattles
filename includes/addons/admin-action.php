  ...
  <tr>
    <td align=center>
        ...
        <input type="button" class="lbut" onclick="location='/includes/addons/admin-action/adm.php?id_adm=99'"
               value="Передача вещей персонажам"/>
