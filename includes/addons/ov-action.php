    ...
    <table cellpadding=4 cellspacing=0 border=0 width=100%>
        <tr>
            <td><font class=nickname><b><?php echo sclonch($sign['clan_sclon']); ?><img
                                ...
                                align=absmiddle
                                title="<?php echo $sign['clan_name']; ?>"> <?php echo $sign['clan_name']; ?></b></font>
            </td>
                            ...
                            <tr>
                                <td bgcolor="#<?php echo(($_GET['addid'] == 1) ? 'FFFFFF' : 'F0F0F0'); ?>" width="25%">
                                    <div align="center"><a href="?useaction=clan-action&addid=1" class="nickname"><font
                                                    class="nickname"><b>Состав <?php echo $sign['clan_name']; ?></b></font></a>
                                    </div>
                                </td>
                                <td bgcolor="#<?php echo(($_GET['addid'] == 2) ? 'FFFFFF' : 'F0F0F0'); ?>" width="25%">
                                    <div align="center"><a href="?useaction=clan-action&addid=2" class="nickname"><font
                                                    class=nickname><b>Денежная казна, Бонусы</b></font></a></div>
                                </td>
                                <td bgcolor="#<?php echo(($_GET['addid'] == 3) ? 'FFFFFF' : 'F0F0F0'); ?>" width="25%">
                                    <div align="center"><a href="?useaction=clan-action&addid=3&fullinf=0"
                                                           class="nickname"><font class=nickname><b>Казна</b></font></a>
                                    </div>
                                </td>
                                <td bgcolor="#<?php echo(($_GET['addid'] == 4) ? 'FFFFFF' : 'F0F0F0'); ?>" width="25%">
                                    <div align="center"><a href="?useaction=clan-action&addid=4" class="nickname"><font
                                                    class=nickname><b>Документы</b></font></a></div>
                                </td>
                            </tr>
                        </table>
                    </td>
