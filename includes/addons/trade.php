...
switch (intval($_GET['act'])) {
    case 1:
        ...
        <table cellpadding=4 cellspacing=0 border=0 width=100%>
            <tr>
                <td bgcolor=#e2e2e2><font class=nickname><b>Покупка вещей</b></font></td>
                <td bgcolor=#e2e2e2 align="right"><input type=button class=lbut
                                                         onclick="parent.$.modal.close();location='main.php?post_id=1&act=2&login=<?= $login ?>&vcode=<?= scode() ?>'"
                                                         value="Отказаться"></td>
                <td bgcolor=#e2e2e2>
                    <div align=right>
                        ...
                        <img src=/img/image/exit.png align=absmiddle width=15 height=15 border=0></a></div>
                </td>
            </tr>
        </table>
    ...
    case 2:
        ...
        <table cellpadding=4 cellspacing=0 border=0 width=100%>
            <tr>
                <td bgcolor=#FCFAF3><font class=nickname><b>Покупка вещей</b></font></td>
                <td bgcolor=#FCFAF3>
                    <div align=center><input type=button class=lbut
                                             onclick="location='main.php?post_id=1&act=2&login=<?= $login ?>&vcode=<?= scode() ?>'"
                                             value="Отказаться от покупки"></div>
                </td>
                <td bgcolor=#FCFAF3>
                    <div align=right>
                        <script language="JavaScript">
                        ...
                        <noscript><a href=exit.php target=_top></noscript>
                        <img src=/img/image/exit.gif align=absmiddle width=15 height=15 border=0></a></div>
                </td>
            </tr>
        </table>
        <table cellpadding=0 cellspacing=0 border=0 width=100%>
            <tr>
                <td bgcolor=#Ffffff><img src=/img/image/1x1.gif width=1 height=1></td>
            </tr>
            <tr>
                <td bgcolor=#B9A05C><img src=/img/image/1x1.gif width=1 height=1></td>
            </tr>
            <tr>
                <td bgcolor=#F3ECD7><img src=/img/image/1x1.gif width=1 height=2></td>
            </tr>
    ...
    <table cellpadding=0 cellspacing=0 border=0 width=100%>
        <tr>
            <td bgcolor=#D8CDAF width=50% colspan=3>
                <div align=center><font class=invtitle><font color=#000000>свойства</font></div>
            </td>
            <td bgcolor=#B9A05C><img src=/img/image/1x1.gif width=1 height=16></td>
            <td bgcolor=#D8CDAF width=50% colspan=3>
                <div align=center><font class=invtitle><font color=#000000>требования</font></div>
            </td>
        </tr>
        <tr>
