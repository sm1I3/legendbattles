...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
  <tr>
    ...
    <td valign="top" width="100%"><table cellpadding="0" cellspacing="0" border="0" width="100%">
      ...
      <tr>
        <td><a href="/main.php"><img src="http://img.legendbattles.ru/image/gameplay/invent/0.gif" width="44" height="53" title="Вещи" class="cath" border="0" /></a><a href="#"><img src="http://img.legendbattles.ru/image/gameplay/invent/6.gif" width="41" height="53" title="Эликсиры" class="cath" border="0" /></a><a href="#"><img src="http://img.legendbattles.ru/image/gameplay/invent/1.gif" width="41" height="53" title="Алхимия" class="cath" border="0" /></a><a href="#"><img src="http://img.legendbattles.ru/image/gameplay/invent/2.gif" width="41" height="53" title="Рыбалка" class="cath" border="0" /></a><a href="#"><img src="http://img.legendbattles.ru/image/gameplay/invent/3.gif" width="41" height="53" title="Ресурсы" class="cath" border="0" /></a><img src="http://img.legendbattles.ru/image/gameplay/invent/4.gif" width="41" height="53" title="Руны" /><img src="http://img.legendbattles.ru/image/gameplay/invent/5.gif" width="41" height="53" title="Магия" /><a href="/main.php?im=7"><img src="http://img.legendbattles.ru/image/gameplay/invent/7.gif" width="41" height="53" title="Журнал заданий" /></a></td>
      </tr>
      <tr>
...
<tr><td bgcolor=#FCFAF3><font class=nickname><img src=http://img.legendbattles.ru/image/money_all.gif width=16 height=14 border=0 title='Передать LR' align=absmiddle <? if($player[level]>4 and $player[finblock]<time()){?>onClick="transferform('0','0','Игровую валюту','<?=scod()?>','0','0','0','0')"<? }?> vspace=0>&nbsp;Деньги:</td><td width=100% bgcolor=#fafafa nowrap><font class=nickname><b>&nbsp;<?=$player['nv']." LR";?></td>
<? if($player['dd']>0){ ?>
<tr><td bgcolor=#FCFAF3><font class=nickname><img src=http://img.legendbattles.ru/image/money_dea.gif width=16 height=14 border=0 title='Передать/Обменять DLR' onClick="transferform('1','0','Обменять/перевести DLR','<?=scod()?>','0','0','0','0')" vspace=0>&nbsp;DLR:</td><td width=100% bgcolor=#FAfafa nowrap><font class=nickname><b>&nbsp;<?=$player['dd']." DLR";?></td></tr> <? }?>
</tr>
<? if($player['baks']>0){ ?>
...
<input type=button class=invbut onClick="compl_f('<?=scod()?>')" value="Запомнить комплект">
 <input type=button class=invbut onClick="javascript: location='main.php?post_id=57&act=3&vcode=<?=scod()?>'" value="Снять все вещи">
 <br>
...
<tr><td bgcolor=#F0F0F0 colspan=3 align=center class=freemain><B>Ваши комплекты</B></td></tr>
<SCRIPT language="JavaScript">
<?
...
default: include($_SERVER["DOCUMENT_ROOT"]."/index.php"); // если в переменной $mselect не будет передано значение, которое учтено выше, то открывается главная страница
break;
}
}
   ?>
