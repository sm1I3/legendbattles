...
if($_POST['present']!='none' and !empty($_POST['present'])){
	if(!empty($_POST['delete'])){
		$items=mysqli_fetch_array(mysqli_query($GLOBALS['db_link'],"SELECT * FROM `chests2` WHERE `id`='".$_POST['present']."' LIMIT 1;"));
		$additem="";
	...
	if($_GET['add']==1){
	$present=mysqli_fetch_array(mysqli_query($GLOBALS['db_link'],"SELECT * FROM `chests2` WHERE `id`='".$_POST['present']."';"));
	echo'
