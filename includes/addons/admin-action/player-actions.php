...
<table width="60%" border="0" cellspacing="0" cellpadding="0" align=center>
  <tr>
    <td align=center>
		...
		<input type=button class=lbut onClick="location=\'player-actions.php\'" value="обновить">
	</td>
   </tr>
   <tr>
    <td align=center>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align=center>
		<input type="button" class="lbut" onclick="location='player-actions.php?perslogin=<?php echo $_POST['perslogin'];?>&id_adm=1'" value="получил уровень" />
		<input type="button" class="lbut" onclick="location='player-actions.php?perslogin=<?php echo $_POST['perslogin'];?>&id_adm=2'" value="получил опыт" />
		<input type="button" class="lbut" onclick="location='player-actions.php?perslogin=<?php echo $_POST['perslogin'];?>&id_adm=3'" value="изменения в балансе DLR" />
		<input type="button" class="lbut" onclick="location='player-actions.php?perslogin=<?php echo $_POST['perslogin'];?>&id_adm=4'" value="изменения в балансе BAKS" />
	</td>
	</tr>
	  <tr>
    <td align=center>
		<input type="button" class="lbut" onclick="location='player-actions.php?perslogin=<?php echo $_POST['perslogin'];?>&id_adm=10'" value="покупка в ДЦ" />
		<input type="button" class="lbut" onclick="location='player-actions.php?perslogin=<?php echo $_POST['perslogin'];?>&id_adm=11'" value="продажа в ДЦ" />
		<input type="button" class="lbut" onclick="location='player-actions.php?perslogin=<?php echo $_POST['perslogin'];?>&id_adm=12'" value="покупка в магазине" />
		<input type="button" class="lbut" onclick="location='player-actions.php?perslogin=<?php echo $_POST['perslogin'];?>&id_adm=13'" value="продажа в магазин" />
		<input type="button" class="lbut" onclick="location='player-actions.php?perslogin=<?php echo $_POST['perslogin'];?>&id_adm=14'" value="аренда в ДЦ" />
		<input type="button" class="lbut" onclick="location='player-actions.php?perslogin=<?php echo $_POST['perslogin'];?>&id_adm=15'" value="рассрочка в ДЦ" />
	</td>
	</tr>
	  <tr>
    <td align=center>		
		<input type="button" class="lbut" onclick="location='player-actions.php?perslogin=<?php echo $_POST['perslogin'];?>&id_adm=16'" value="перевод другим персонажам (LR)" />
		<input type="button" class="lbut" onclick="location='player-actions.php?perslogin=<?php echo $_POST['perslogin'];?>&id_adm=17'" value="перевод другим персонажам (DLR)" />
		<input type="button" class="lbut" onclick="location='player-actions.php?perslogin=<?php echo $_POST['perslogin'];?>&id_adm=20'" value="покупка у игрока" />
		<input type="button" class="lbut" onclick="location='player-actions.php?perslogin=<?php echo $_POST['perslogin'];?>&id_adm=21'" value="продажа игроку" />
	</td>	
	</tr>
	 <tr>
    <td align=center>
		<input type="button" class="lbut" onclick="location='player-actions.php?perslogin=<?php echo $_POST['perslogin'];?>&id_adm=22'" value="бонус по рефералке (LR)" />
		<input type="button" class="lbut" onclick="location='player-actions.php?perslogin=<?php echo $_POST['perslogin'];?>&id_adm=23'" value="лицензии" />
		<input type="button" class="lbut" onclick="location='player-actions.php?perslogin=<?php echo $_POST['perslogin'];?>&id_adm=24'" value="рынок" />
	</td>	
	</tr>
	<tr>
    <td align=center>
		<input type="button" class="lbut" onclick="location='player-actions.php?perslogin=<?php echo $_POST['perslogin'];?>&bank=1'" value="БАНК И ДЦ" />
	</td>	
	</tr>
	 <tr>
    <td align=center>
		<input type="button" class="lbut" onclick="location='player-actions.php?perslogin=<?php echo $_POST['perslogin'];?>&id_adm=0'" value="ВСЕ СРАЗУ" />
		<input type="button" class="lbut" onclick="location='player-actions.php?perslogin=<?php echo $_POST['perslogin'];?>&chat=1'" value="ЧАТ" />
	</td>	
	</tr>
<tr>
</table>	
