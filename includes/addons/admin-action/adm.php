...
</select> <input name="smb7" type="submit" class="lbut" value="Применить фильтр"/><? $filter2 = "WHERE master=''";
    if ($smb7) {
        if ($type == "") {
            $filter = "";
...
if($fr!="")echo "<label><font class=weaponch><b>$fr</b></font></label><input name=tr[$i] type=text value=\"$ned[$i]\"/><br>\n";
  ...
  <div align="center">
      <input name="smb4" type="submit" class="lbut" value="Сохранить"/> <input name="smb1" type="submit" class="lbut"
