		...
		<td><table width="100%" cellpadding="0" cellspacing="2">
			<tr>
				<td bgcolor="#cccccc"><table cellpadding="0" cellspacing="1" width="100%" border="0">
					<tr>
						<td bgcolor="#<?php echo (($_GET['type']=='1')?'FFFFFF':'F0F0F0'); ?>" width="50%"><div align="center"><a href="?useaction=admin-action&addid=tavern&type=1"><font class=nickname><b>Алкоголь</a></div></td>
						<td bgcolor="#<?php echo (($_GET['type']=='2')?'FFFFFF':'F0F0F0'); ?>" width="50%"><div align="center"><a href="?useaction=admin-action&addid=tavern&type=2"><font class=nickname><b>Закуска</a></div></td>
					</tr>
					<tr>
