...
<table width="60%" border="0" cellspacing="0" cellpadding="0" align=center>
  <tr>
    <td align=center>
		...
		<input type="button" class="lbut" onclick="location='koldyn.php?create=1'" value="Создание  Рецепта" />
		<input type="button" class="lbut" onclick="location='koldyn.php?look=1'" value="Просмотр рецептов" />
		<input type="button" class="lbut" onclick="location='koldyn.php?look=2'" value="Просмотр игроков" />
	</td>
   </tr>
</table>
<? 
...
if($create==1){
	...
	if($itm!=""){		
		...
		echo'
		<input type=text name=col onBlur="if (value == \'\') {value=\'Количество\'}" onFocus="if (value == \'Количество\') {value =\'\'}" value="'.($_POST['colr']?$_POST['colr']:'Количество').'" onmouseover="tooltip(this,\'<b>Введите количество зелий которое получится при создании</b>\')" onmouseout="hide_info(this)"><font class=fish_skillma style="color: gray; font-size: 9px;"> (по умолчанию: 5)</font>
		<br><input type=text name=price onBlur="if (value == \'\') {value=\'Цена рецепта\'}" onFocus="if (value == \'Цена рецепта\') {value =\'\'}" value="'.($_POST['pricer']?$_POST['pricer']:'Цена рецепта').'" onmouseover="tooltip(this,\'<b>Введите цену рецепта</b>\')" onmouseout="hide_info(this)"><font class=fish_skillma style="color: gray; font-size: 9px;"> (по умолчанию: 100 LR)</font>
		<br><input type=text name=nav onBlur="if (value == \'\') {value=\'Навык Колдуна\'}" onFocus="if (value == \'Навык Колдуна\') {value =\'\'}" value="'.($_POST['navr']?$_POST['navr']:'Навык Колдуна').'" onmouseover="tooltip(this,\'<b>Введите необходимый навык Колдуна для использования и покупки данного рецепта</b>\')" onmouseout="hide_info(this)"><font class=fish_skillma style="color: gray; font-size: 9px;"> (по умолчанию: 1)</font>
		...
		<br><font class=fish_skillma style="color: red;"><b>&nbsp;Внимание: </font></b><font class=fish_skillma>Проверок на минусовые значения нет, не подставляйте значения типа "-200" в цену или количество. Если рецепт на эту вещь уже существует в базе - он будет заменен новым.
...
<table border=0 cellpadding=4 cellspacing=1 bordercolor=#e0e0e0 align=center class="smallhead" width=100%>
		<tr class=nickname bgcolor=#EAEAEA>
			<td align=center width=10%><b>ID</b><br><font class=fish_skillma style="color: gray; font-size: 9px;">ид рецепта в базе</font></td>
			<td align=center width=50%><b>Имя предмета</b><br><font class=fish_skillma style="color: gray; font-size: 9px;">предмет который создаем</font></td>
			<td align=center width=10%><b>ID предмета</b><br><font class=fish_skillma style="color: gray; font-size: 9px;">ид предмета в базе</font></td>
			<td align=center width=20%><b>Реагенты</b><br><font class=fish_skillma style="color: gray; font-size: 9px;">Название (количество)</font></td>
			<td align=center width=10%><b>Количество</b><br><font class=fish_skillma style="color: gray; font-size: 9px;">сколько будет создано</font></td>
			<td align=center width=10%><b>Навык</b><br><font class=fish_skillma style="color: gray; font-size: 9px;">необходимый для создания</font></td>
			<td align=center width=10%><b>Цена</b><br><font class=fish_skillma style="color: gray; font-size: 9px;">цена рецепта</font></td>
			<td align=center width=10%><b>Действия</b><br><font class=fish_skillma style="color: gray; font-size: 9px;">редактировать или удалить</font></td>
		</tr>
...
<table border=0 cellpadding=4 cellspacing=1 bordercolor=#e0e0e0 align=center class="smallhead" width=100%>
		<tr class=nickname bgcolor=#EAEAEA>
			<td align=center width=10%><b>Игрок</b><br><font class=fish_skillma style="color: gray; font-size: 9px;">имя</font></td>
			<td align=center width=50%><b>Навык Колдуна</b><br><font class=fish_skillma style="color: gray; font-size: 9px;">у игрока</font></td>
			<td align=center width=50%><b>Рецепты</b><br><font class=fish_skillma style="color: gray; font-size: 9px;">(ид рецептов)</font></td>
		</tr>
	...
	while ($row = mysqli_fetch_assoc($players)){
			...
			<td align=center>Колдуна: '.$row['koldyn'].' ('.$pt[75].' с вещами)<br>Рыбак: '.$row['fish_skill'].' ('.$pt[70].' с вещами)</td><td>';
