...
<table width="60%" border="0" cellspacing="0" cellpadding="0" align=center>
  <tr>
      <td><input type=button class=lbuts onClick="location='?useaction=admin-action&addid=botdrop'" value="обновить">
      </td>
   </tr>
</table>
<?
...
if($_POST['bot']!='none'){
	...
	if($_GET['add']==1){
		...
		if(!empty($chbot)){
            ...
            $chclr = "red";
            $msg = "Бот не найден в базе! Заполните нужные поля и нажмите \"сохранить\".";
			$ich=10000;
			$lch=10000;
			$bch=10000;
			$mch=10000;
