...
$response = array (
        ...
        'тыкто' => array ( 1 =>
                'Я чат-бот.',
                'А ты?',
				'Я самообучающийся робот проекта Life is War версии 0.1',
                ),
		...
		/* карта */
        'карта' => array ( 1 =>
                "На данный момент карта доступна по ссылке <a href=\"#\" onclick=\"window.open(\\'http://www.lifeiswar.ru/liwworld.php\\');\"><font color=#3564A5><b>http://www.lifeiswar.ru/liwworld.php</b></font></a>",
				"Вот держи: <a href=\"#\" onclick=\"window.open(\\'http://www.lifeiswar.ru/liwworld.php\\');\"><font color=#3564A5><b>http://www.lifeiswar.ru/liwworld.php</b></font></a>",
				"<a href=\"#\" onclick=\"window.open(\\'http://www.lifeiswar.ru/liwworld.php\\');\"><font color=#3564A5><b>http://www.lifeiswar.ru/liwworld.php</b></font></a>",
				"Держи, я не жадный <a href=\"#\" onclick=\"window.open(\\'http://www.lifeiswar.ru/liwworld.php\\');\"><font color=#3564A5><b>http://www.lifeiswar.ru/liwworld.php</b></font></a>",
                ),
		'кач' => array ( 1 =>
		...
		/* клиент */
        'клиент' => array ( 1 =>
                "Вот держи: <a style=\"color: #B70000;\" href=\"#\" onclick=\"window.open(\\'http://www.lifeiswar.ru/client/LiWClient_w.rar\\');\" target=\"_blank\">Скачать</a>",
				"Вот держи: <a style=\"color: #B70000;\" href=\"#\" onclick=\"window.open(\\'http://www.lifeiswar.ru/client/LiWClient_w.rar\\');\" target=\"_blank\">Скачать</a>"
                ),
