...
function view_act($pers){
    $sql = mysqli_query($GLOBALS['db_link'], "SELECT * FROM mlog WHERE login='" . $pers['login'] . "' AND action!='вход в игру' ORDER BY action;");
...
if (@$_POST['pip'] and in_array('1',$access)) {
    if ($pers['login'] != 'Администрация' and $pers['login'] != 'Железный' and $pers['login'] != 'Истребитель' and $pers['login'] != 'Зов Ада' and $pers['login'] != 'злая-_-милашка' and $pers['clan'] != 'Life') {
		view_ip($pers);
	} else {
        echo "<font class=chattime>&nbsp;" . date("H:i:s") . "&nbsp;</font> <font color=000000><b><font color=#CC0000>Вы не можете просматривать информацию об этом персонаже!";
    }
...
function fightoff($persto,$perswho){
    echo "<font class=chattime>&nbsp;" . date("H:i:s") . "&nbsp;</font> <font color=000000><b><font color=#CC0000>Внимание!</font></b></font>&nbsp;Персонаж <b>" . $persto['login'] . "</b> Вытащин из боя (<b>" . $perswho['login'] . "</b>).</font>";
        ...
        if ($ip != $row['ip']) {
			...
			if(mysqli_num_rows($oneip)>0){
				while($newrow = mysqli_fetch_array($oneip)){
                    if ($login != $newrow['login'] and $newrow['login'] != 'Администрация' and $newrow['login'] != '') {
                        $login = $newrow['login'];
						echo"<tr>";
...
function molch($persto,$perswho,$duration,$reason){
	if ($duration>-1){
        ...
        echo "<font class=chattime>&nbsp;" . date("H:i:s") . "&nbsp;</font> <font color=000000><b><font color=#CC0000>Внимание!</font></b></font>&nbsp;На персонажа <b>" . $persto['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $persto['login'] . "\" target=\"_blank\"><img src=http://d0009394.atservers.net/img/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $persto['login'] . "\');\" ></a> наложено заклятие молчания сроком на " . $timemolch . ". " . $chreason . " (<b>" . $perswho['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $perswho['login'] . "\" target=\"_blank\"><img src=http://d0009394.atservers.net/img/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $perswho['login'] . "\');\" ></a>)</font>";
        ...
        echo "<font class=chattime>&nbsp;" . date("H:i:s") . "&nbsp;</font> <font color=000000><b><font color=#CC0000>Внимание!</font></b></font>&nbsp;<b>" . $perswho['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $perswho['login'] . "\" target=\"_blank\"><img src=http://d0009394.atservers.net/img/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $perswho['login'] . "\');\" ></a> снял заклятие молчания с персонажа <b>" . $persto['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $persto['login'] . "\" target=\"_blank\"><img src=http://d0009394.atservers.net/img/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $persto['login'] . "\');\" ></a>.</font>";
		mysqli_query($GLOBALS['db_link'],"UPDATE `user` SET `sleep`='0' WHERE `login`='".$persto['login']."' LIMIT 1;");
        chmsg("<font class=chattime>&nbsp;" . date("H:i:s") . "&nbsp;</font> <font color=000000><b><font color=#CC0000>Внимание!</font></b></font>&nbsp;<b>" . $perswho['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $perswho['login'] . "\" target=\"_blank\"><img src=http://d0009394.atservers.net/img/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $perswho['login'] . "\');\" ></a> снял заклятие молчания с персонажа <b>" . $persto['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $persto['login'] . "\" target=\"_blank\"><img src=http://d0009394.atservers.net/img/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $persto['login'] . "\');\" ></a>.</font>");
...
function fmolch($persto,$perswho,$duration,$reason){
	if ($duration>-1){
        ...
        echo "<font class=chattime>&nbsp;" . date("H:i:s") . "&nbsp;</font> <font color=000000><b><font color=#CC0000>Внимание!</font></b></font>&nbsp;Персонаж <b>" . $persto['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $persto['login'] . "\" target=\"_blank\"><img src=http://d0009394.atservers.net/img/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $persto['login'] . "\');\" ></a> лишается права общения на форуме на " . $timemolch . " (<b>" . $perswho['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $perswho['login'] . "\" target=\"_blank\"><img src=/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $perswho['login'] . "\');\" ></a>).</font>";
        ...
        echo "<font class=chattime>&nbsp;" . date("H:i:s") . "&nbsp;</font> <font color=000000><b><font color=#CC0000>Внимание!</font></b></font>&nbsp;<b>" . $perswho['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $perswho['login'] . "\" target=\"_blank\"><img src=http://d0009394.atservers.net/img/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $perswho['login'] . "\');\" ></a> снял запрет форумного молчания с персонажа <b>" . $persto['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $persto['login'] . "\" target=\"_blank\"><img src=/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $persto['login'] . "\');\" ></a>.</font>";
...
function prison($persto,$perswho,$duration,$reason){
	if ($duration>0){
		...
		$duration *= 86400;
        echo "<font class=chattime>&nbsp;" . date("H:i:s") . "&nbsp;</font> <font color=000000><b><font color=#CC0000>Внимание!</font></b></font>&nbsp;Персонаж <b>" . $persto['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $persto['login'] . "\" target=\"_blank\"><img src=http://d0009394.atservers.net/img/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $persto['login'] . "\');\" ></a> отправлен в тюрьму (<b>" . $perswho['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $perswho['login'] . "\" target=\"_blank\"><img src=/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $perswho['login'] . "\');\" ></a>).</font>";
        ...
        echo "<font class=chattime>&nbsp;" . date("H:i:s") . "&nbsp;</font> <font color=000000><b><font color=#CC0000>Внимание!</font></b></font>&nbsp;Персонаж <b>" . $persto['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $persto['login'] . "\" target=\"_blank\"><img src=http://d0009394.atservers.net/img/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $persto['login'] . "\');\" ></a> выпущен  из тюрьмы (<b>" . $perswho['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $perswho['login'] . "\" target=\"_blank\"><img src=/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $perswho['login'] . "\');\" ></a>).</font>";
        chmsg("<font class=chattime>&nbsp;" . date("H:i:s") . "&nbsp;</font> <font color=000000><b><font color=#CC0000>Внимание!</font></b></font>&nbsp;Персонаж <b>" . $persto['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $persto['login'] . "\" target=\"_blank\"><img src=http://d0009394.atservers.net/img/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $persto['login'] . "\');\" ></a> выпущен  из тюрьмы (<b>" . $perswho['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $perswho['login'] . "\" target=\"_blank\"><img src=/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $perswho['login'] . "\');\" ></a>).</font>");
...
function block($persto,$perswho,$duration,$reason){
	if ($duration!=2){
        ...
        echo "<font class=chattime>&nbsp;" . date("H:i:s") . "&nbsp;</font> <font color=000000><b><font color=#CC0000>Внимание!</font></b></font>&nbsp;НА персонажа <b>" . $persto['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $persto['login'] . "\" target=\"_blank\"><img src=http://d0009394.atservers.net/img/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $persto['login'] . "\');\" ></a> наложено заклятие смерти. Пусть земля тебе будет пухом. (<b>" . $perswho['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $perswho['login'] . "\" target=\"_blank\"><img src=/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $perswho['login'] . "\');\" ></a>).</font>";
...
function mprision($persto,$perswho){
    echo "<font class=chattime>&nbsp;" . date("H:i:s") . "&nbsp;</font> <font color=000000><b><font color=#CC0000>Внимание!</font></b></font>&nbsp;Персонаж <b>" . $persto['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $persto['login'] . "\" target=\"_blank\"><img src=http://d0009394.atservers.net/img/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $persto['login'] . "\');\" ></a> телепортирован в тюрьму (<b>" . $perswho['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $perswho['login'] . "\" target=\"_blank\"><img src=/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $perswho['login'] . "\');\" ></a>).</font>";
...
function verification($persto,$perswho,$duration,$reason){
	switch($duration){
		case'1':
            ...
            echo "<font class=chattime>&nbsp;" . date("H:i:s") . "&nbsp;</font> <font color=000000><b><font color=#CC0000>Внимание!</font></b></font>&nbsp;Персонаж <b>" . $persto['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $persto['login'] . "\" target=\"_blank\"><img src=http://d0009394.atservers.net/img/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $persto['login'] . "\');\" ></a> Прошел проверку (<b>" . $perswho['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $perswho['login'] . "\" target=\"_blank\"><img src=/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $perswho['login'] . "\');\" ></a>).</font>";
            chmsg("<font class=chattime>&nbsp;" . date("H:i:s") . "&nbsp;</font> <font color=000000><b><font color=#CC0000>Внимание!</font></b></font>&nbsp;Проверка пройдена. (<b>" . $perswho['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $perswho['login'] . "\" target=\"_blank\"><img src=/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $perswho['login'] . "\');\" ></a>).</font>", $persto['login']);
		...
		case'2':
            ...
            echo "<font class=chattime>&nbsp;" . date("H:i:s") . "&nbsp;</font> <font color=000000><b><font color=#CC0000>Внимание!</font></b></font>&nbsp;Персонаж <b>" . $persto['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $persto['login'] . "\" target=\"_blank\"><img src=http://d0009394.atservers.net/img/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $persto['login'] . "\');\" ></a> Прошел проверку (Условно) (<b>" . $perswho['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $perswho['login'] . "\" target=\"_blank\"><img src=/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'ipers/" . $perswho['login'] . "\');\" ></a>).</font>";
            chmsg("<font class=chattime>&nbsp;" . date("H:i:s") . "&nbsp;</font> <font color=000000><b><font color=#CC0000>Внимание!</font></b></font>&nbsp;Проверка пройдена (условно). (<b>" . $perswho['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $perswho['login'] . "\" target=\"_blank\"><img src=/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $perswho['login'] . "\');\" ></a>).</font>", $persto['login']);
		...
		break;
		case'3':
            echo "<font class=chattime>&nbsp;" . date("H:i:s") . "&nbsp;</font> <font color=000000><b><font color=#CC0000>Внимание!</font></b></font>&nbsp;Персонаж <b>" . $persto['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $persto['login'] . "\" target=\"_blank\"><img src=http://d0009394.atservers.net/img/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $persto['login'] . "\');\" ></a> Не прошел проверку (<b>" . $perswho['login'] . "</b><a style=\"COLOR: #336699;text-decoration : none;cursor: pointer;\" href=\"/ipers/" . $perswho['login'] . "\" target=\"_blank\"><img src=/image/chat/info.gif width=11 height=12 border=0 onClick=\"window.open(\'/ipers/" . $perswho['login'] . "\');\" ></a>).</font>";
