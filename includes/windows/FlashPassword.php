...
<body onResize="resizer()">
    ...
    <div id="auth">
        ...
        <param name="movie" value="/modules/flashpass.swf">
        <param name="quality" value="high">
        <param name="bgcolor" value="#ececec">
        <param name="allowScriptAccess" value="sameDomain">
        <param name="flashvars" value="plid='.$PLAY['id'].'">
        <embed src="/modules/flashpass.swf" quality="high" bgcolor="#ececec" flashvars="plid='.$PLAY['id'].'" width="294" height="328" name="flashpass" align="middle" play="true" loop="false" quality="high" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.adobe.com/go/getflashplayer"></embed>
        </object>
    </div>
</body>
</html>';
